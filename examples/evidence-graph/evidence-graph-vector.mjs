...
// Generated from evidence-graph-vector.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
if (result.verdict !== 'admissible')
    throw new Error(`expected admissible, got ${result.verdict}: ${result.reasons}`);
if (!check.accepted)
    throw new Error('reliance result did not verify+accept');
...
if (stale.verdict !== 'stale')
    throw new Error(`expected stale, got ${stale.verdict}`);
