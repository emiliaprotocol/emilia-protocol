...
/* eslint-disable */
import { buildSyntheticRegulatoryDemo, defaultOutputDirectory, verifyRegulatoryEvidence, writeDemoArtifacts, } from './lib.mjs';
...
wrongPins.approver_keys[demo.evidence.execution_record.device_key_id].public_key = 'AA';
