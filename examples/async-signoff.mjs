...
// Generated from async-signoff.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
class SignoffStore {
    ...
    approve(id) { const s = this.pending.get(id); if (s)
        s.status = 'approved'; }
