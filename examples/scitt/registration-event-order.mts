...
function registration(record: any, field: string) {
...
function isVerifiedPreEffectEntry(record: any) {
  return record.phase === 'PENDING_BEFORE_EFFECT'
    && record.native_verification === 'VERIFIED';
}

function isVerifiedEffectTerminal(entry: any, terminal: any) {
 ...
 */
export function assessRegistrationEventOrder({ first, second, cross_log_relationship: relationship = null }: any) {
