...
// Generated from capsule-seam-vector.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
function main() {
    ...
    for (const n of negs)
        console.log(`    ${n.enforced ? 'ENFORCED' : 'MISSING '} ${n.id} → ${n.must} (${n.reason})`);
    if (emit) {
