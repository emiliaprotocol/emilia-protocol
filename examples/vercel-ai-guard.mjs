...
// Generated from vercel-ai-guard.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
 ...
 */
export function withEmiliaGuard(tool, { action, context, ...opts } = {}) {
    if (!tool || typeof tool.execute !== 'function')
        return tool;
    if (!action)
        throw new Error('withEmiliaGuard: { action } is required');
