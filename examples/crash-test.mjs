...
// Generated from crash-test.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
async function main() {
    ...
    await pause(900);
    // 1. The agent acts.
    const action = { amount: 82000, currency: 'USD', destination: 'acct_new_4471', vendor: 'Acme Industrial LLC' };
