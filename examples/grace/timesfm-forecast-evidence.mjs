...
// Generated from timesfm-forecast-evidence.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import crypto from 'node:crypto';
import { FORECAST_EVIDENCE_VERSION, TIMESFM_ADAPTER_PROFILE, assessForecastForGrace, buildTimesFmForecastEvidence, forecastDigest, reconcileForecastObservation, } from '../../lib/grace/forecast-evidence.js';
import { graceDigest, signGraceArtifact, verifyGraceArtifact, } from '../../lib/grace/mobile-grid.js';
