...
import { canonicalize, createGate, createMemoryCapabilityStore, executeWithCapability, CAPABILITY_SCOPE_PROFILE, capabilityActionDigest, mintDeviceSignoff, mintCapabilityReceipt, } from '../../packages/gate/index.js';
import { createSignedMockProvider, } from './provider.mts';
import { createReconciliationLedger, reconcileIndeterminateEffect, } from './reconciliation.mts';
...
export function createIndeterminateEffectHarness() {
    ...
    return Object.freeze({
        ...
        reconcile(providerEvidence = provider.getSignedEvidence(OPERATION_ID)) {
            // reconciliation.mts's reconcileIndeterminateEffect has no JSDoc signature, so
    ...
    return Object.freeze({
        first_attempt: {
            ...
            authorization: {
                ...
                execution_binding_ok: first.authorization?.evidence?.execution_binding?.ok === true,
            },
        },
