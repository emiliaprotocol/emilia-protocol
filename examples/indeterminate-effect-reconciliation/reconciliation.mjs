...
// Generated from reconciliation.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import { canonicalize, hashCanonical, reconcileCapabilityOperation, } from '../../packages/gate/index.js';
...
export async function reconcileIndeterminateEffect({ capabilityStore, capabilityId, operationId, action, providerEvidence, pinnedProviderKey, expectedProviderId, ledger, now = () => '2026-07-19T04:00:10.000Z', } = {}) {
    ...
    const verifiedEvidence = verified;
    const recordBody = {
