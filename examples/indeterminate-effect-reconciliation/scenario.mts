...
function mintBaseReceipt(privateKey: any, publicKey: any): any {
...
export function createIndeterminateEffectHarness(): any {
  ...
  return Object.freeze({
    ...
    attempt: execute,
    retry: execute,
    reconcile(providerEvidence: any = provider.getSignedEvidence(OPERATION_ID)): any {
...
export async function runIndeterminateEffectDemo(): Promise<any> {
