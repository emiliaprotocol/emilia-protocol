...
// Generated from recourse-reference-vector.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
function buildRecourse(overrides = {}) {
    const body = {
...
function main() {
    ...
    for (const n of negatives) {
        ...
        const ok = n.expect(v);
        allNeg = allNeg && ok;
        console.log(`    ${ok ? 'ENFORCED' : 'MISSING '} ${n.id} → ${n.reason}`);
    }
