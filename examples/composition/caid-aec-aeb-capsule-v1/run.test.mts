...
test('profile pins the active Capsule -02 revision', () => {
  ...
  assert.equal(
    capsule.sha256,
    'sha256:493428486c85e03624bc1d90e8265b072b98265b93b7bd50d55824688a1802d8',
  );
});
...
test('post-dispatch timeout is sticky indeterminate and observer conflict is divergent', () => {
  ...
  const divergenceCase = cases.find(
    (entry) => entry.id === 'independent_observer_contradiction',
  );
