...
const yn = (value: any) => (value === true ? 'yes' : value === false ? 'no' : String(value));

function printCanonicalDerivation(scene: any): void {
  console.log(`\n1. ${scene.title}`);
  console.log(rule());
...
function printAuthorized(scene: any): void {
  console.log(`\n2. ${scene.title}`);
  console.log(rule());
  for (const entry of scene.transports) {
...
function printDrift(scene: any): void {
  console.log(`\n3. ${scene.title}`);
  console.log(rule());
...
function printUnresolved(scene: any): void {
  console.log(`\n4. ${scene.title}`);
  console.log(rule());
...
function printSpentOnce(scene: any): void {
...
function print(result: any): void {
