...
function signA(digestHex: string) {
...
function buildReceipt() {
  ...
  const receipt: any = { receipt_id: 'ep:receipt:pa-specialty-001', action, action_hash, contexts: [ctx1, ctx2], signoffs, consumption: { nonce: 'n-pa', state: 'COMMITTED', committed_at: '2026-07-08T14:04:02Z' } };
