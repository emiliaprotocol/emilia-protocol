...
// Generated from auth-service.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
function originalRequest(headers) {
...
function sendProblem(response, refusal) {
...
const authorize = createReceiptRequiredEdgeHandler({
    ...
    async consume(receiptId, context) {
        const result = await pool.query(`INSERT INTO ep_edge_receipt_consumptions (action, receipt_id)
       VALUES ($1, $2)
       ON CONFLICT (action, receipt_id) DO NOTHING
       RETURNING receipt_id`, [context.action, receiptId]);
