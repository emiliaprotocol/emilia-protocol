...
// Generated from grok-guard.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
import { evaluateGuardPolicy, hashCanonicalAction, GUARD_ACTION_TYPES, } from '../lib/guard-policies.js';
...
async function callGrok(messages) {
    ...
    if (!res.ok)
        throw new Error(`xAI ${res.status}: ${JSON.stringify(data).slice(0, 300)}`);
