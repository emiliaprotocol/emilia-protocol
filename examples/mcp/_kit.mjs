...
// Generated from _kit.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
function demoWebAuthnSignoff(payload, approver) {
    ...
    const signature = crypto.sign('sha256', Buffer.concat([authenticatorData, sha256(clientDataBytes)]), approver.privateKey);
    return {
        contextHash,
        signoff: {
...
export function signAction(action, { approver, outcome = 'allow_with_signoff', quorum = null, tamper = false } = {}) {
    ...
    if (assuranceProof)
        payload.assurance_proof = assuranceProof;
...
export async function runDemo({ title, tool, args, approver, agentLine }) {
    ...
    if (!req)
        throw new Error(`tool "${tool}" not found in the Action Risk Manifest`);
