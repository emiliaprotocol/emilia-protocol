...
import {
  ...
  type ExecutionIntegrityAttestation,
...
const APPROVED_HASH = actionHash(APPROVED_ACTION as any);
...
const PERMIT_POSTURE: FipsPosture = {
...
const REFUSE_POSTURE: FipsPosture = {
  ...PERMIT_POSTURE,
...
}) as ExecutionIntegrityAttestation;
