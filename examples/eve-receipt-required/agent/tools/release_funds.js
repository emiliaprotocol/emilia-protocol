...
// Generated from release_funds.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
export default defineTool({
    description: 'Release funds to a destination account. IRREVERSIBLE. Requires an EMILIA authorization receipt ' +
    ...
    async execute({ amount, currency, destination, emilia_receipt }) {
        const result = await releaseFundsGate.run(emilia_receipt, { target: destination }, async () => {
