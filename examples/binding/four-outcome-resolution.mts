...
(relabeled as any).signoff.context.resolution = { outcome: 'approved', selected_option: 0 };
...
console.log(`relabel  refused=${!attack.valid} reason=${(attack as any).reason ?? 'unspecified'}`);
