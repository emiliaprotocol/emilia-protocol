...
// Generated from four-outcome-resolution.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
import { RESOLUTION_CONTEXT_TYPE, RESOLUTION_VERSION, computeBindingMomentHash, computeResolutionChallenge, computeResolutionResponseHash, verifyResolutionReceipt, } from '../../packages/verify/resolution.js';
...
if (attack.valid || attack.authorizes_action)
    throw new Error('outcome relabeling was accepted');
