...
if (verifyBinding(host, tampered, [pub]).verified)
...
if (verifyBinding(hostOther, other, [pub]).verified)
...
if (verifyBinding({ ...host, human_authorization_ref: undefined }, artifact, [pub]).verified)
