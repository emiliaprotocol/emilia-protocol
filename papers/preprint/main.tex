...
% Canonical Markdown SHA-256: 730f633cc50cdb81a99bde224e6c940210de7a9f0d63ad060795e71ef3adf4c5
% Every quantitative claim is traceable to a repository artifact:
%   - conformance 21 suites / 332 vectors -> conformance/conformance-manifest.json
%     (totals.suites=21, totals.vectors=332)
%     manifest_sha256=35a941437c60413204d9a02aafde9d40047cc9fadf15eeaaaca9f3e2b9c5ed4d
...
21-suite/332-vector conformance battery, and separately authored Rust verifier
...
\emph{one repository}: they are same-team ports whose agreement across all 332
...
with JavaScript, Python, and Go same-team ports); the 21-suite / 332-vector
