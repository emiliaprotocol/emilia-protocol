...
% Canonical Markdown SHA-256: 1ae7e117eec7d1579a35aea99e5c3403c6afc86f8a8852d402daa72d21d591e7
...
%     (totals.suites=21, totals.vectors=328)
%     manifest_sha256=7b92abb58146daa1307b6b1e1aaac390cd75f40cf0c2f641f2ed4b74156ba31b
...
set of individual Internet-Drafts (\code{draft-schrock-ep-authorization-receipts-07}
...
(Section 6).
\item A cross-language conformance battery (21 suites, 328 vectors) whose
...
battery of 21 suites comprising 328 vectors. The receipt vectors are self-contained
...
\emph{one repository}: they are same-team ports whose agreement across all 328
...
with JavaScript, Python, and Go same-team ports); the 21-suite / 328-vector
...
Internet-Draft \code{draft-schrock-ep-authorization-receipts-07}, work in progress,
July 2026.
...
\code{draft-schrock-ep-authorization-evidence-chain-03}, work in progress, July
2026.
