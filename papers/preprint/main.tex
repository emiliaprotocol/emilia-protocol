...
% Canonical Markdown SHA-256: 8bb9a1161cfaa03e2ff94a3b2dd8e17d397d92e6965748eb437be8bb1fa6a6a3
...
%     manifest_sha256=851c0066743774566485ba2a704764698eb96c1439f9ec0d3725e735507b7dec
...
primary contribution is a four-model symbolic-security analysis under a
...
receipt core and a 2-of-2 quorum instance. Two composed models analyze the path
from signed challenge and computed action identifier through profile, approval,
scoped authority, exact pinned reliance configuration, durable challenge
consumption, action-keyed fleet execution, and one-time authorization consumption.
Across the composed models, 17 all-traces properties and three reachability
witnesses verify; eight deliberately weakened comparisons are falsified with
concrete attack traces. Complementary TLA+ (26 invariants over 413,137
...
\item \textbf{A four-model symbolic-security analysis (Section 7), the paper's
...
and may obtain honest signatures over arbitrary actions. Two composed models
analyze the path from challenge and computed action identifier through approvals,
scoped authority, exact pinned reliance configuration, durable challenge
consumption, action-keyed fleet execution, and one-time authorization
consumption. Across the composed models, 17 all-traces properties and three
reachability witnesses verify; eight deliberately weakened comparisons produce
concrete attack traces when load-bearing restrictions are removed. We report
that falsification history and bound the models' exclusions exactly.
