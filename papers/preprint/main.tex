...
% Canonical Markdown SHA-256: ea61e8b79c075f16bb93a74031a4b2562d7e094f9cce2e2b62ad8ca497148c29
% Every quantitative claim is traceable to a repository artifact:
%   - conformance 21 suites / 335 vectors -> conformance/conformance-manifest.json
%     (totals.suites=21, totals.vectors=335)
%     manifest_sha256=c8453dca4850e778cfbfe3ce2c794e9ba74baed3d921184fcc4800d9bbbc3ad9
...
21-suite/335-vector conformance battery, and separately authored Rust verifier
...
\emph{one repository}: they are same-team ports whose agreement across all 335
...
with JavaScript, Python, and Go same-team ports); the 21-suite / 335-vector
