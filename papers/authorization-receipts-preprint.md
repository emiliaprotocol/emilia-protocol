...
- **Bounded validation.** The reference implementation, historical 21-suite/335-vector conformance battery, and separately authored Rust verifier validate encoding and interoperability. They are not presented as independent security proofs.
