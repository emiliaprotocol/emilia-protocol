...
- **ConsumeOnce.** Within one shared atomic consumption domain, a nonce transitions to a terminal state at most once; any second presentation to that domain is rejected as a replay.
