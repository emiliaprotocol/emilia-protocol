...
%   - Alloy 15 + 7 = 22 assertions -> formal/PROOF_STATUS.md
...
checked in Alloy (6.1.0, SAT4J). One model proves fifteen assertions over the
...
observer-independent portability). These relational checks treat Ed25519
