...
export async function requireBiometric(promptMessage = 'Approve this action') {
...
export async function getEnrolledPublicKeyHex() {
 ...
 *
 * @param {string} challenge - base64url challenge from ep-signoff.challengeFromContext
 * @param {{ rpId:string, origin:string }} opts
 */
export async function signChallenge(challenge, { rpId, origin }) {
