// Generated from ep-signoff.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
export async function challengeFromContext(context) {
    if (!subtle)
        throw new Error('Web Crypto subtle unavailable in this runtime');
...
export function buildAttestation({ context, webauthn, approverId }) {
    if (!context || !webauthn)
        throw new Error('buildAttestation requires context and webauthn');
    return {
