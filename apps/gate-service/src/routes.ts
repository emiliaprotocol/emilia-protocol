...
function sendJson(response: any, status: number, body: any, headers: Record<string, string> = {}) {
...
async function readStrictJsonBody(request: any, maxBytes: number): Promise<Record<string, any>> {
...
function receiptCarrier(request: any, maxChars: number): string | null | 'duplicate-receipt-carrier' | 'invalid-receipt-carrier' {
  let count = 0;
...
function exactQuery(url: URL, { pagination = false }: any = {}): any {
...
function unauthorized(response: any): void {
