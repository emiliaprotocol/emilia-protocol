...
export function invariant(condition: boolean, name: string, detail: string) {
...
function parseArgs(argv: string[]): { target: string | null; seed: number; seeds: string | undefined; iterations: number } {
  const args = { target: null as string | null, seed: 1, seeds: undefined as string | undefined, iterations: 200 };
...
function seedRange(spec: string | undefined, fallbackSeed: number) {
