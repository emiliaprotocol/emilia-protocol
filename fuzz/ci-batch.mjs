...
// Generated from ci-batch.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
const teeth = spawnSync(process.execPath, ['--test', raceTeethSelftest], { stdio: 'inherit' });
if (teeth.status !== 0)
    failed = true;
for (const [target, seeds, iterations] of BATCH) {
    if (failed)
        break;
    const args = [harness, target, '--seeds', seeds, '--iterations', String(iterations)];
