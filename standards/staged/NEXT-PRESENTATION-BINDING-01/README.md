# Presentation Binding -01 boundary candidate
...
and HTML produced from that source. `SELECTIVE-DISCLOSURE.md` remains a
separate candidate section and is deliberately not assembled into this scoped
issue #753 render.
