...
Table of Contents
   ...
   5.  Relationship to Other Work  . . . . . . . . . . . . . . . . .   3
...
3.  Gate Predicates (Fail-Closed)
   ...
   expires_at.  Otherwise the action is refused and no posture change
   occurs.
...
6.  Security Considerations
   ...
   closed.  EP is a necessary, not sufficient, condition for trustworthy
   demand response.
