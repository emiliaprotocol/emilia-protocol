...
| 2 | `application/authorization-evidence-challenge+json` | Media Types (provisional, standards tree) | draft-schrock-ae-challenge-00 (§2, §5) | **Requests provisional registration** and fixes the complete wire string | READY-ON-POST (provisional) | Draft active on Datatracker; submit the prepared provisional request |
