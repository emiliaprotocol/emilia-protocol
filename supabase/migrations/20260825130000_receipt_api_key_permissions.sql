-- Forward-only expansion of audited tenant API-key issuance to exact,
-- least-privilege receipt operation capabilities.
...
BEGIN
  IF p_tenant_id IS NULL
     ...
     OR NOT p_permissions <@ ARRAY['read', 'write', 'admin', 'policy_rollout', 'approval_request', 'receipt.read', 'receipt.evidence', 'receipt.consume', 'receipt.execute']::TEXT[]
