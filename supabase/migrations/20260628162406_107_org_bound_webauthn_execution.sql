ALTER TABLE approver_credentials ADD COLUMN IF NOT EXISTS organization_id TEXT;
ALTER TABLE webauthn_challenges ADD COLUMN IF NOT EXISTS organization_id TEXT;
