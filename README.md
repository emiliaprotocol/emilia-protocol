...
**6,621 automated tests across 345 files**.
...
| Metric | Value |
|---|---|
| Automated test cases | 6,621 across 345 files; all platform-applicable cases must pass |
