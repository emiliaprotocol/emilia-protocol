...
EMILIA ships a security case that reviewers can execute. The current repository resolves **18
security claims over 86 hashed evidence files**, verifies **10 obligations in one composed Tamarin
...
225 current vectors**. Separately, an externally authored Rust verifier is pinned to the frozen
