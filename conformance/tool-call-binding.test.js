...
// Generated from tool-call-binding.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
describe('EP-TOOL-CALL-BINDING-v1', () => {
    ...
    it('the vectors discriminate: the "arguments" material must not reproduce them', () => {
        ...
        const brokenBinder = (tool, args, base) => `${base}:sha256:${createHash('sha256').update(canonical({ tool, arguments: args })).digest('hex')}`;
        for (const v of VECTORS.vectors) {
