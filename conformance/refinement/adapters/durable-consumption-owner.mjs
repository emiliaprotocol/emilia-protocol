...
// Generated from durable-consumption-owner.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import { createDurableConsumptionStore, createMemoryBackend, } from "../../../packages/gate/dist/store.js";
...
export async function runDurableConsumptionOwnerScenario(scenario) {
    ...
    if (scenario === "durable-consumption-owner-happy-path") {
        ...
        return {
            ...
            steps: [
                {
                    ...
                    projection: {
                        ...
                        competingReservationRefused: projection.competingReservationRefused,
            ...
            relation: relation({ owner: "owner-a", competing_owner: "owner-b" }, projection, projection),
        };
    }
    if (scenario === "durable-consumption-stale-owner-refused") {
        await ownerA.reserve("receipt:stale-owner");
        await backend.compareAndSet("receipt:stale-owner", "reserved:v2:owner-a-token-0000000000000001", "reserved:v2:owner-b-token-0000000000000001");
        ...
        const replacementPreserved = (await backend.get("receipt:stale-owner")) ===
    ...
    if (scenario === "durable-consumption-restart-refused") {
        ...
        const reservationPreserved = /^reserved:v2:/u.test((await backend.get("receipt:restart")) ?? "");
        const projection = {
        ...
        return {
            ...
            relation: relation({ restarted_process_has_owner_token: false }, projection, projection),
        };
    }
