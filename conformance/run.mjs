...
const SUITES = ['receipts.v1.json', 'signoffs.v1.json', 'quorum.v1.json', 'revocation.exec.v1.json', 'time-attestation.v1.json', 'trust-receipt.exec.v1.json'];
...
if (totalFailures === 0) {
  console.log('\n✅ receipts · signoffs · quorum · revocation · time-attestation · trust-receipt — three independent implementations agree.');
  process.exit(0);
}
