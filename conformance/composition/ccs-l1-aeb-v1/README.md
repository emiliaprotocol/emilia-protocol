...
# CCS 1.1.14 L1 receipt to AEB composition v1

This runner consumes the exact published `ccs-verifier==1.1.14` reference
receipt as `machine-policy-decision` evidence. It verifies the Ed25519
...
The eight cases cover the published source pin, valid receipt, signature
