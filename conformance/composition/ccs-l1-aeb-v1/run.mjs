...
export function runSuite() {
    ...
    const checks = [
        check('CCS-1.1.14-SOURCE-PIN', 'CCS', 'The exact published PyPI 1.1.14 release and reference vector are pinned.', f.vector.package_version === CCS_L1_PYPI_DISTRIBUTION_VERSION
