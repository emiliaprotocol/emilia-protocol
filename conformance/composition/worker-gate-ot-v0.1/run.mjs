...
export async function buildReferenceReport() {
    ...
    cases.push(caseResult('ACTION-DIGEST-AND-CAID', 'prerequisite', actionCanonical === fixture.action.A_canonical && actionDigest === fixture.action.A_digest, 'the collaborator JCS digest reproduces exactly and EMILIA computes a typed CAID without treating the digest as authority', { fixture_digest: actionDigest, caid: baseCaid.caid, caid_digest: baseCaid.digest }));
