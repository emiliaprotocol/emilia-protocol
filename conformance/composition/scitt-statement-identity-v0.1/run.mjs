...
const P256_SIGNATURE_A = Buffer.from('YtBJi0iCj0mpfA7XdmW1viyF3F2efFAVIphq9ZLEGBzuXTcgQSSYPHKBCfHUQvgBXzGQ0AdO2kLhgtSNnr1hYA', 'base64url');
const P256_SIGNATURE_B = Buffer.from('YtBJi0iCj0mpfA7XdmW1viyF3F2efFAVIphq9ZLEGBwRosjevttnxI1-9g4rvQf-XbVp3Z_IxEISNvY1XaXD8Q', 'base64url');
...
export function runProfile() {
    const protectedBytes = must(encodeDeterministicCbor8949(new Map([
        [1, -7],
