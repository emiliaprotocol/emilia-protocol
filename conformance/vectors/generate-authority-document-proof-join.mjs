...
// Generated from generate-authority-document-proof-join.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
 ...
 * }} [options]
 */
function buildDocs({ usages = ['evidence_issuer', 'authority_proof_issuer'], initialUsages = usages, validFrom = '2026-01-01T00:00:00.000Z', validTo = '2027-01-01T00:00:00.000Z', revokedAt = undefined, continuityKey = root0, doc1IssuedAt = '2026-06-01T00:00:00.000Z', addRevocationDoc = false, registryIssuerId = REGISTRY_ISSUER_ID, } = {}) {
    const issuerEntry = {
        key: pub(issuer),
...
function fixture(mutation) {
    ...
    switch (mutation) {
        ...
        case 'document_head_registry_head_confusion': {
            ...
            const authorityDocument = /** @type {{head_digest:string,head_seq:number,issuer_kid:string}} */ (proof.authority_document);
            proof = {
                ...proof,
                authority_document: {
                    ...authorityDocument,
        ...
        case 'full_issuer_kid_mismatch': {
            const authorityDocument = proof.authority_document;
            proof = {
                ...proof,
                authority_document: {
                    ...authorityDocument,
...
const catalogue = JSON.parse(fs.readFileSync(new URL('./authority-document-proof-join.v1.json', import.meta.url), 'utf8'));
...
fs.writeFileSync(new URL('./authority-document-proof-join.exec.v1.json', import.meta.url), `${JSON.stringify(suite, null, 2)}\n`);
