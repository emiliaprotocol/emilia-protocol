...
// Generated from generate-timestamp-forms.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
import { buildContexts, collectSignoffs, assembleAuthorizationReceipt, policyHash as computePolicyHash, generateEd25519KeyPair, } from '../../packages/issue/index.js';
const FLAG_UP = 0x01;
const FLAG_UV = 0x04;
function newP256() {
...
async function mint({ issuedAt, expiresAt, committedAt, keyFrom, keyTo, requiredApprovals = 1 }) {
    ...
    const contexts = buildContexts({ action, policyHash: computePolicyHash({ policy_id: action.policy_id }), approvers: ['ep:approver:dir'], requiredApprovals: requiredApprovals, issuedAt, expiresAt });
