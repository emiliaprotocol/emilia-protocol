...
function makeSignoff({ tamperContextAfterSign = null, flags = 0x05, type = 'webauthn.get', rpId = 'emiliaprotocol.ai', wrongKey = false, malformSig = false } = {}) {
...
const add = (id, description, failure_class, expectValid, built) =>
  V.push({ id, description, failure_class, expect: { valid: expectValid }, rp_id: built.rp_id, approver_public_key: built.approver_public_key, signoff: built.signoff });
