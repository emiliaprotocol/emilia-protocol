...
// Generated from generate-signoffs.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
function makeSignoff({ tamperContextAfterSign = null, flags = 0x05, type = 'webauthn.get', rpId = 'emiliaprotocol.ai', origin = 'https://www.emiliaprotocol.ai', duplicateChallenge = false, invalidUtf8 = false, paddedClientData = false, wrongKey = false, malformSig = false, } = {}) {
    ...
    const deliveredContext = tamperContextAfterSign ? { ...context, ...tamperContextAfterSign } : context;
    return {
        signoff: {
            '@type': 'ep.signoff',
...
const V = [];
const add = (id, description, failure_class, expectValid, built) => V.push({ id, description, failure_class, expect: { valid: expectValid }, rp_id: built.rp_id, allowed_origins: built.allowed_origins, approver_public_key: built.approver_public_key, signoff: built.signoff });
