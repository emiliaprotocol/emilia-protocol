 ...
 */
function record(signer: any, { renewalHashed = null as string | null, t0 = t(0), t1 = t(1) } = {}) {
...
const V: any[] = [];
const add = (id: string, expectValid: boolean, vec: any) => V.push({ id, expect: { valid: expectValid }, ...vec });
