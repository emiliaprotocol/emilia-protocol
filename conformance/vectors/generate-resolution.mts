...
const PUBLIC_KEY = crypto.createPublicKey(PRIVATE_KEY as any)
...
function makeReceipt(resolution, {
  ...
  const deliveredContext = tamperAfterSign ? { ...context, ...(tamperAfterSign as any) } : context;
  return {
...
const malformedHatches = malformedMoment.question.hatches as any;
