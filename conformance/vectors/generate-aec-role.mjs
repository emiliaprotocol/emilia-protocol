...
// Generated from generate-aec-role.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
const vectors = [
    ...
    },
    {
        ...
        policies_by_type: { 'ep-receipt': (() => {
                ...
                const entry = Object.values(profile.approver_keys)[0];
    ...
    },
    {
        ...
        stub_types: [],
        policies_by_type: { 'ep-quorum': (() => {
                const q = clone(thresholdQuorum);
                delete q.policy.distinct_humans;
...
const suite = {
    ...
    description: 'EP-AEC acceptance suite with REAL Ed25519 and Class-A WebAuthn signatures plus RP-scoped profiles, run cross-language through the built-in verifiers. '
