...
addInit('reject_missing_model_id', false, (() => { const a = validAtt() as any; delete a.model_id; return a; })());
...
addInit('reject_missing_digest', false, (() => { const a = validAtt() as any; delete a.tool_chain_digest; return a; })());
...
function cosign(cpt, id, k) {
  const digest = witnessSigningDigest(cpt) as Buffer;
