...
// Generated from generate-model-to-matter.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
// Generate deterministic EP-MODEL-TO-MATTER-v1 public vectors.
import crypto from 'node:crypto';
import { writeFileSync } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { M2M_CLEARANCE_VERSION, M2M_CAID_ACTION_TYPE, M2M_EVIDENCE_TYPES, createModelToMatterAction, createModelToMatterProfile, modelToMatterActionDigest, modelToMatterCaid, signModelToMatterEffect, signModelToMatterEvidence, } from '../../lib/frontier/model-to-matter.js';
