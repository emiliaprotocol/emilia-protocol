...
// Generated from run-js.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
if (!Array.isArray(vectors))
    throw new Error('conformance corpus must contain a vectors array');
...
const out = vectors.map((v) => {
    ...
    if (v.currency)
        return { id: v.id, ...validResult(evaluateCurrency(v.currency.args).currency_at_T.status === v.currency.expect_status) };
