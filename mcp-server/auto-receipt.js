// Generated from auto-receipt.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
function secureApiUrl(value) {
    ...
    if (parsed.username || parsed.password)
        throw new Error('epApiUrl must not contain credentials');
    parsed.hash = '';
...
export class AutoReceiptMiddleware {
    ...
    async _submitBatch(receipts) {
        ...
        try {
            ...
            throw new Error('Auto-submit returned invalid JSON');
        }
    }
    /**
