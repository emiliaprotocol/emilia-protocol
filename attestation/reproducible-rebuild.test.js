...
// Generated from reproducible-rebuild.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
describe('assertPinnedSource', () => {
    ...
    it('FAIL-CLOSED: rejects uncommitted or untracked source', () => {
        expect(() => assertPinnedSource({ commit: COMMIT_A }, fakeGit({ status: ' M packages/verify/index.js' }))).toThrow(/source_worktree_dirty/);
    });
});
