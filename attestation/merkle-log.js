// Generated from merkle-log.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
 ...
 */
function inclusionPath(i, leaves) {
 ...
 */
export function buildLogEntry(leafSubjects, index) {
 ...
 */
export function assembleRecord(source, artifact, otherSubjects = []) {
    const record = {
