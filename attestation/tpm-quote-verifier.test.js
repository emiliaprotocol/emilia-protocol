...
// Generated from tpm-quote-verifier.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import { readFileSync } from 'node:fs';
import { describe, expect, it } from 'vitest';
import { parseTpm2Quote, parseTpm2Signature, verifyTpm2Quote, } from './tpm-quote-verifier.js';
const fixture = JSON.parse(readFileSync(new URL('./tpm2-tools-swtpm-quote.fixture.json', import.meta.url), 'utf8'));
...
function mutateBase64(value, mutate) {
