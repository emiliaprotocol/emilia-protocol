...
//
//   npx @emilia-protocol/scan protect <actions.json|openapi.json|--sample> [--out ./emilia] [--apply] [--force]
//
...
const files = [
  ...
  ...(!isHttp ? [{ rel: path.join(outDir, 'verify-setup.mjs'), body: verifySetupJs }] : []),
