...
//
// Vendored copy of the EMILIA Gate default action packs, so @emilia-protocol/scan
// is a self-contained standalone install with no runtime dependency on the full
// Gate package. The authoritative source is packages/gate/action-packs.js; a
// monorepo-only test (test.js) asserts this copy has not drifted from it. If that
// test fails, re-sync this file from the Gate.
