...
export declare const MOBILE_CHALLENGE_VERSION = "EP-MOBILE-CHALLENGE-v1";
 ...
 * @returns {Object}
 */
export declare function buildMobileAuthorizationContext({ actionHash, policyId, policyHash, initiatorId, approverId, approverIndex, requiredApprovals, nonce, issuedAt, expiresAt, decision, displayHash, profileHash, platform, appId, deviceKeyId, credentialId, attestationKeyId, }?: AnyRecord): AnyRecord;
 ...
 * @returns {Object}
 */
export declare function createMobileChallenge({ action, policy, policyId, initiatorId, approverId, approverIndex, requiredApprovals, decision, presentation, platform, appId, deviceKeyId, profile, issuedAt, expiresAt, challengeId, nonce, }?: AnyRecord): AnyRecord;
/**
