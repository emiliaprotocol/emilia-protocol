...
// Generated from consent-grant.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
import { buildConsentGrant, computeGrantHash, verifyGrantHash, verifyConsentGrant, verifyReceiptUnderGrant, receiptReferencedGrantHash, receiptGrantBindingStrength, CONSENT_GRANT_VERSION, } from './consent-grant.js';
function newSigner() {
...
function actionSelfConsistent(receipt) {
    ...
    try {
        ...
        sigOk = crypto.verify(null, Buffer.from(canonicalize(receipt.action), 'utf8'), key, Buffer.from(receipt.signature.value, 'base64url'));
    }
    catch {
        sigOk = false;
    }
