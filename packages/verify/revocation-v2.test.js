...
// Generated from revocation-v2.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
import { REVOCATION_VERSION, REVOCATION_V2_VERSION, REVOCATION_V2_REQUIRED_ALGORITHMS, revocationV2SignedPayload, verifyRevocation, verifyRevocationV2, verifyRevocationStatement, isRevoked, isRevokedAny, } from './revocation.js';
...
async function buildV2({ revokerId = REVOKER_ID, revokedAt = '2026-06-20T12:00:00.000Z', reason = 'authority withdrawn', actionHash = TARGET.action_hash, requiredAlgorithms = [...REVOCATION_V2_REQUIRED_ALGORITHMS], } = {}) {
    const fields = {
