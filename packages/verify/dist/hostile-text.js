...
export const BIDI_CODEPOINTS = new Set([
...
export const INVISIBLE_CODEPOINTS = new Set([
...
export function isHostileCodepoint(cp) {
 ...
 */
export function scanHostileText(value) {
...
export function hasHostileText(value) {
 ...
 */
export function scanHostileDeep(value, depth = 0) {
    if (depth > 16)
        return [];
    if (typeof value === 'string')
        return scanHostileText(value);
    if (Array.isArray(value)) {
        const out = [];
        for (const item of value)
            out.push(...scanHostileDeep(item, depth + 1));
        return [...new Set(out)];
    }
...
//# sourceMappingURL=hostile-text.js.map