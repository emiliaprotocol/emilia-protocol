...
export function bindInto(action, att) {
    ...
    if (existing !== undefined && canonicalize(existing) !== canonicalize(v.normalized)) {
        throw new Error(`bindInto: action already carries a different ${INITIATOR_ATTESTATION_FIELD}; refusing to overwrite`);
    }
...
//# sourceMappingURL=initiator-attestation.js.map