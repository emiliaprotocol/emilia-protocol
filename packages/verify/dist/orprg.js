 ...
 */
export function inspectOrprgJsonJcsPermit(input, options = {}) {
    try {
        ...
        const checks = newChecks();
        const result = deny('MALFORMED_RECEIPT', 'unexpected input or verifier state was denied', baseDetail(checks));
