...
import { DISCOVERY_PERMIT_RESOLUTION_VERSION, digestDiscoveryPermit, isDiscoveryPermitResolverAttestation, isDiscoveryPermitResolution, pinDiscoveryPermitTrust, rederiveDiscoveryPermitResolutionFromPinnedDocuments, verifyDiscoveryPermitResolverAttestationSignature, } from './discovery-permit-contract.js';
...
function validConfig(value) {
    if (!exactKeys(value, CONFIG_KEYS)
        ...
        || value.resolver.max_attestation_age_seconds <= 0)
        return false;
...
function configMatches(config, resolution) {
...
function baseResult(input, overrides, reasons) {
...
function nativeStatusReasons(input) {
...
export function createAebDiscoveryPermitAdapter() {
    return Object.freeze({
...
//# sourceMappingURL=aeb-discovery-permit-adapter.js.map