...
import {
  ...
  authorizeAgentContinuityExecution,
  authorizeAgentContinuityExecutionDurable,
  createA2AHandoffContinuity,
  createAgentContinuityEnvelope,
  createEffectContinuity,
  createMcpToolContinuity,
  verifyAgentContinuityEnvelope,
  verifyAgentContinuityGraph,
} from './agent-edge-continuity.js';
import { digestAeb, InMemoryAebConsumptionStore } from './aeb-adapter-contract.js';

const vectors = JSON.parse(fs.readFileSync(
  new URL('../../conformance/vectors/agent-edge-continuity.v1.json', import.meta.url),
  'utf8',
));
