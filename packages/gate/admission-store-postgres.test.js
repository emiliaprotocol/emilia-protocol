...
test('real PostgreSQL enforces reserve, supersession, currentness, crash recovery, and consumed truth', {
    ...
    try {
      ...
      ON CONFLICT (deployment_id, authority_id) DO UPDATE SET
        ...
        const abandonedInput = admissionInput('admission:abandoned-before-invocation', 'operation:abandoned-before-invocation', reaperNow, { expires_at: iso(reaperNow + 250) });
