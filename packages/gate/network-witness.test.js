...
// Generated from network-witness.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import test from 'node:test';
import assert from 'node:assert/strict';
import crypto from 'node:crypto';
import { NETWORK_WITNESS_ACCEPTANCE_VERSION, acceptNetworkWitnessStatement, createMemoryWitnessSequenceStore, parseNetworkWitnessStatement, signNetworkWitnessStatement, validateTrustedNetworkWitnessAcceptance, verifyNetworkWitnessStatement, } from './network-witness.js';
...
test('online ingestion refuses replay, rollback, equivocation, ephemeral production stores, and outages', async () => {
    ...
    assert.equal((await acceptNetworkWitnessStatement(afterEquivocation, options)).reason, 'sequence_equivocation');
