 ...
 */
function fail(verdict: string, profileHash: string | null = null, extra: Record<string, boolean> = {}) {
  return {
    accepted: false,
    verified: false,
    verdict,
 ...
 */
export async function verifyDeploymentAttestation(evidence, options: DeploymentAttestationOptions = {}) {
  let profile;
  let invalid;
  try {
