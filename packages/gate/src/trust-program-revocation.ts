...
function applyRefusal(reason: string, verification?: ReturnType<typeof verifyTrustProgramRevocation>) {
  return {
...
function lateDisposition(
  reason: string,
  verification: ReturnType<typeof verifyTrustProgramRevocation>,
  state: unknown,
  applied = false,
) {
  return {
