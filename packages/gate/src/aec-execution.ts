...
const HUMAN_FLOORS: Set<string | undefined> = new Set(['class_a', 'quorum', 'class_a_or_quorum']);
...
export function createAECExecutionGate({
  ...
  async function deny(
    ...
    extra: Obj = {},
  ): Promise<{ ok: false; allow: false; reason: string; result: Obj | null; decision: any; value?: undefined; authorization?: undefined; execution?: undefined }> {
    let decision = null;
    try {
      const entry = {
  ...
  async function run(
    request: Obj = {},
    effect: (input: { action: any; result: any; authorization: any }) => any,
  ): Promise<
    | { ok: false; allow: false; reason: string; result: Obj | null; decision: any; value?: undefined; authorization?: undefined; execution?: undefined }
    | { ok: true; allow: true; value: any; result: any; authorization: any; execution: any; reason?: undefined }
  > {
