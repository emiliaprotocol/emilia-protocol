 ...
 * closed verdicts.
 */
export async function evaluateGateControlPlane(
  input: { settlements?: any[]; coverage?: Record<string, any>; usage?: any } = {},
  options: {
    now?: number;
  ...
  let settlementItems: readonly any[] = [];
  ...
  let coverageInput: Record<string, any> = {};
  try {
  ...
  let coverageWitnesses: any[] | null = null;
  try {
  ...
  const coverageIngestionResults: any[] = [];
  ...
  for (const item of settlementItems) {
    ...
    const settlementOptions: {
      ...
      now: any;
      pinnedWitnesses: any;
      witnessMaxAgeSec: any;
      maxFutureSkewSec: any;
      witnessSequenceStore: any;
      allowEphemeralWitnessStore: any;
      verifyAuthorization: any;
      verifyExecution: any;
      verifyOutcome: any;
      verifyCoverage: () => Promise<any>;
      trustedWitnessAcceptance?: any;
    } = {
  ...
  let usage: ReturnType<typeof buildUsageStatement> | null = null;
