...
export const HIGH_RISK_ACTION_PACKS: readonly ActionPack[] = Object.freeze([
  Object.freeze({
...
export const DEFAULT_PASS_THROUGH_ACTIONS: readonly ActionPack[] = Object.freeze([
  Object.freeze({
...
export function createDefaultActionRiskManifest({
  includePassThrough = true,
  extraActions = [],
}: { includePassThrough?: boolean; extraActions?: ActionPack[] } = {}) {
  return {
