...
function validatePayload(payload: any): { ok: true } | { ok: false; reason: string } {
  ...
  if (payload.version !== EXECUTION_VALUE_ATTESTATION_VERSION) return { ok: false, reason: 'execution_value_version_unsupported' };
