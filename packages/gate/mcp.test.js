...
// Generated from mcp.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
test('gateMcpTool runs the tool with a valid Class-A receipt and attaches proof', async () => {
    const { gate, harness, action } = setup();
    let ran = false;
    const tool = gateMcpTool(gate, { tool: 'release_payment', observedAction: () => action }, async () => { ran = true; return { wire_id: 'w_1' }; });
