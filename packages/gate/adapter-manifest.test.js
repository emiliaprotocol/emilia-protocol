...
// Generated from adapter-manifest.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import assert from 'node:assert/strict';
import crypto, { generateKeyPairSync } from 'node:crypto';
import test from 'node:test';
import { loadAdapterManifestRegistry, signAdapterManifest, } from './adapter-manifest.js';
