...
// Generated from execution-value.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import test from 'node:test';
import assert from 'node:assert/strict';
import { generateKeyPairSync } from 'node:crypto';
import { createExecutionValueProviderEntryGuard, signExecutionValueAttestation, verifyExecutionValueAttestation, hashCanonical, providerEntryContext, } from './index.js';
...
test('execution value attestation is signature-, action-, source-, time-, and cap-bound', () => {
    ...
    const tampered = structuredClone(f.attestation);
