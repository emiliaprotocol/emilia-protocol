...
// Generated from consequence-envelope.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
import { FINANCE_CUMULATIVE_EXPOSURE_PROFILE, GRACE_CURTAILMENT_IMPACT_PROFILE, GRID_ACTIVE_POWER_PROFILE, allocateConsequenceEnvelopeSlice, createConsequenceEnvelopeBoundary, createMemoryConsequenceEnvelopeStore, issueConsequenceEnvelope, verifyConsequenceEnvelope, } from './dist/consequence-envelope.js';
...
async function financeBoundary(capacityUnits = '1000', epoch = 7) {
    ...
    return { keys, envelope, store, boundary, setNow: (value) => { currentTime = value; } };
}
