 ...
 */
export function createPostgresActionRefusalReplayStore({ query, tenantId, gateId, } = {}) {
    ...
    return Object.freeze({
        ...
        async consume(relyingPartyId, nonce, refusalDigest) {
            ...
            if (!DIGEST.test(refusalDigest))
                throw new TypeError('refusalDigest is invalid');
...
//# sourceMappingURL=action-refusal-postgres.js.map