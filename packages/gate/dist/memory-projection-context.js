 ...
 */
import { MemoryProjectionVerificationError, verifyMemoryProjectionRecordV1Envelope, } from '@emilia-protocol/verify/memory-projection';
...
function copyAdapterKeys(value) {
    if (!isDataRecord(value))
        throw new TypeError('memory projection adapter keys required');
    const copy = {};
...
export function createMemoryProjectionContextProvider(options) {
...
//# sourceMappingURL=memory-projection-context.js.map