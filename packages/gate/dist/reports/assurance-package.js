 ...
 */
export function reperformAssurancePackage(pkg, { approverKeys = {}, logPublicKey = null, rpId = null, allowedOrigins = [], revokerKeys = {}, isConsumed, now = 0, expectedPackageDigest = null, expectedProfileHash = null, } = {}) {
    ...
    const doc = {
        ...
        honesty: {
            reperforms: 'Independent recomputation of every reliance verdict from the packaged evidence, under the presented '
