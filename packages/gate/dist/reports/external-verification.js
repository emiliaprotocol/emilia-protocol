...
export const EXTERNAL_VERIFICATION_V2_REQUIRED_ALGORITHMS = Object.freeze(['Ed25519', 'ML-DSA-65']);
...
function pqKeyIdFor(pqPublicKeyRawB64u) {
 ...
 */
export async function signExternalVerificationStatementV2(args, keys) {
...
export async function verifyExternalVerificationStatementV2(statement, opts = {}) {
    ...
    let setResult;
    try {
        setResult = await verifyAgileSignatureSet(new Uint8Array(signingBytes(unsigned(statement))), sig.signatures, [
...
export async function verifyExternalVerificationStatementAnyVersion(statement, opts = {}) {
    ...
    return verifyExternalVerificationStatement(statement, opts);
}
export default {
...
//# sourceMappingURL=external-verification.js.map