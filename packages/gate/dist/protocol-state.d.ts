 ...
 */
export declare function revoke(_s: Active): Revoked;
/**
 ...
 */
export declare function expire(_s: Active): Expired;
//# sourceMappingURL=protocol-state.d.ts.map