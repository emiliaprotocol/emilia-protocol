...
// Generated from coverage-reconciliation-attestation-v3.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
import { COVERAGE_RECONCILIATION_ATTESTATION_VERSION, COVERAGE_RECONCILIATION_ATTESTATION_V3_VERSION, signCoverageReconciliationAttestation, signCoverageReconciliationAttestationV3, verifyCoverageReconciliationAttestation, verifyCoverageReconciliationAttestationV3, verifyCoverageReconciliationAttestationAny, } from './coverage-reconciliation-attestation.js';
...
test('LEG STRIPPING: removing the ML-DSA leg refuses structurally', async () => {
    const stmt = structuredClone(await buildV3());
...
test('WRONG-LENGTH SIGNATURE: a truncated Ed25519 leg refuses', async () => {
    const stmt = structuredClone(await buildV3());
    const ed25519Leg = stmt.proof.signatures.find((s) => s.alg === 'Ed25519');
