...
// Generated from reliance-kernel.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
test('runtime configuration rejects a missing context function', () => {
    const configured = runtime();
    assert.throws(() => createRelianceKernel({ refusal: { ...configured.refusal, context: null } }), /requires signer and context/);
});
