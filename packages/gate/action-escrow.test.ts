...
function resolutionBindingInput(): any {
  return {
    agreement_digest: AGREEMENT_DIGEST,
...
function common(idempotencyKey: string, overrides: any = {}) {
  return {
    agreement_digest: AGREEMENT_DIGEST,
    document_action_binding_digest: BINDING_DIGEST,
    milestone_id: 'milestone-01',
...
function bindingArtifact(overrides: any = {}) {
  return {
...
function acceptanceArtifact(partyId: string, overrides: any = {}) {
  return {
...
function milestoneEvidence(submitterPartyId: string = 'ep:principal:contractor', overrides: any = {}) {
  return {
...
function resolution(partyId: string, overrides: any = {}) {
...
function fundingStatement(overrides: any = {}) {
  return {
...
function releaseStatement(providerIdempotencyKey: string, overrides: any = {}) {
  return {
...
function commandAuthorization(command: string, partyId: string, overrides: any = {}) {
  return {
...
function verifierBindings(expected: any) {
  return {
