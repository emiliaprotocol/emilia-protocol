...
// Generated from deployment-attestation.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import test from 'node:test';
import assert from 'node:assert/strict';
import { DEPLOYMENT_PROFILE_VERSION, deploymentProfileDigest, verifyDeploymentAttestation, } from './deployment-attestation.js';
