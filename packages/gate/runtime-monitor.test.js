...
// Generated from runtime-monitor.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import test from 'node:test';
import assert from 'node:assert/strict';
import { createRuntimeMonitor, RUNTIME_INVARIANTS, RUNTIME_MONITOR_MODES, } from './runtime-monitor.js';
...
test('monitor bounds process-local cycle state', () => {
    ...
    for (let i = 0; i < 1024; i += 1)
        monitor.beginCheck({ action: 'payment.release' });
