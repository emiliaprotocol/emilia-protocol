...
// Generated from coverage.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
import test from 'node:test';
import assert from 'node:assert/strict';
import crypto from 'node:crypto';
import { COVERAGE_INVENTORY_VERSION, coverageInventoryDigest, evaluateGateCoverage, parseEnforcementProbeStatement, signEnforcementProbe, verifyEnforcementProbe, } from './coverage.js';
