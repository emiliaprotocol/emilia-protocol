...
```bash
npx --package @emilia-protocol/gate@0.23.18 ep-protect activate plan.json \
...
test "$(node -p "require('./node_modules/@emilia-protocol/gate/package.json').version")" = "0.23.13"
printf '%s  %s\n' \
