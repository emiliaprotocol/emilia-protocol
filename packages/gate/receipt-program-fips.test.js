...
// Generated from receipt-program-fips.test.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
describe('EP-RECEIPT-PROGRAM-CERTIFICATE-v1 opt-in FIPS consult', () => {
    ...
    it('passing fipsPosture as a per-request field is refused as a runtime trust-field override attempt', async () => {
        const f = fixture();
        const out = await f.kernel.run(request(f, { fipsPosture: DENYING_POSTURE }), async () => ({
