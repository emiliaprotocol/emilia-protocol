...
import { createSupabaseManifest, guardSupabaseMutation, SUPABASE_OPS, isDestructiveSql, statementHash, rlsDefinitionDigest, RLS_DEFINITION_BINDING_VERSION, } from './supabase.js';
function fakeDb() {
    const calls = [];
    return {
        calls,
