...
const ACTION_FIELD_MAP = Object.freeze({
  ...
  [GUARD_ACTION_TYPES.BENEFIT_ADDRESS_CHANGE]: [...COMMON_FIELDS, ...RECORD_FIELDS, 'address_hash'],
...
export function verifyExecutionBindingContract({
  ...
  for (const field of fields) {
    ...
    if (hashCanonicalAction(normalizedActual) !== hashCanonicalAction(expected)) {
