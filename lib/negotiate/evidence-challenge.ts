...
function validDurableNonce(value) {
  if (typeof value !== 'string' || !DURABLE_NONCE_RE.test(value)) return false;
  try {
...
function presentedActionDigest(presentation): string | null {
  if (presentation?.['@version'] === LEGACY_GRAPH_DOCUMENT_VERSION) {
...
function supportedPresentationDocument(presentation): boolean {
