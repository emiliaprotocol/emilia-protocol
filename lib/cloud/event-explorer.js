...
export async function queryEvents(filters = {}) {
  ...
  allEvents.sort((a, b) => /** @type {any} */ (new Date(b.created_at)) - /** @type {any} */ (new Date(a.created_at)));
...
export async function getTimeline(handshakeId, tenantId) {
  ...
  events.sort((a, b) => /** @type {any} */ (new Date(a.created_at)) - /** @type {any} */ (new Date(b.created_at)));
...
export async function searchEvents(query, filters = {}) {
  ...
  allMatches.sort((a, b) => /** @type {any} */ (new Date(b.created_at)) - /** @type {any} */ (new Date(a.created_at)));
