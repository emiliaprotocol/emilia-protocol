 ...
 * @returns {{ behavioral: number, consistency: number|null, delivery: number|null, product: number|null, price: number|null, returns: number|null }|null}
 */
 ...
 * @returns {{ [dimension: string]: number }} - Contribution of each dimension (0-100 scale)
 */
 ...
 * @returns {{ recommendation: Object|null, analysis: Object, sufficient_data: boolean, reason?: string }}
 */
