 ...
 * EP's software_meta format. This lets the install-preflight endpoint
...
export async function fetchChromeExtensionMeta(extensionId) {
  ...
  try {
    ...
    // For now, return a stub that can be populated from listing_review receipts.
    return {
      software_meta: {
        host: 'chrome',
