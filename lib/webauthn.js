 ...
 * @property {string} ep_version
 * @property {string} context_type
 * @property {string} action_hash
 * @property {string|null} policy_id
 * @property {string|null} policy_hash
 * @property {string} initiator
 * @property {string} approver
 * @property {number} approver_index
 * @property {number} required_approvals
 * @property {string} nonce
 * @property {string} issued_at
 * @property {string} expires_at
 * @property {'approved'|'denied'} [decision]
 * @property {string} [display_hash]
 */
 ...
 * @param {string} params.signoffId
 * @param {string} params.issuedAt
 * @param {string} params.expiresAt
 * @param {'approved'|'denied'|null} [params.decision]
 * @param {string|null} [params.displayHash]
 ...
 * @param {object} context - an AuthorizationContext (or an equivalent plain
 *   object, e.g. one loaded back from storage) to canonicalize and hash.
 */
 ...
 *
 * @param {Uint8Array|Buffer|null|undefined} coseKeyBytes
 */
