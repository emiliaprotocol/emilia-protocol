...
export const GATE_REFERENCE_PROFILES = Object.freeze({
  treasury: Object.freeze({
    ...
    tier: 'class_a',
    policy: 'gate.treasury.payment-release.v1',
  ...
  production: Object.freeze({
    ...
    tier: 'quorum',
    policy: 'gate.production.deploy.v1',
  ...
  healthcare: Object.freeze({
    ...
    tier: 'quorum',
    policy: 'gate.healthcare.override.v1',
