...
export const ENTITY = {
  // Operating entity. VERIFY exact spelling against the CA SOS filing / IRS CP-575
  // before relying on it for contracts (SAM.gov does a character-exact IRS match).
  legalName: 'Future Enterprise Corporation',
  ...
  address: 'Montrose, California, USA — full mailing address on request',
  // CA SOS entity number (optional, public). NEVER put the EIN here.
