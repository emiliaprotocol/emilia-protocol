...
export const SUB_PROCESSORS = [
  ...
  { name: 'Functional Software, Inc. (Sentry)', purpose: 'Error tracking and performance monitoring (10% trace sample)', region: 'United States', data: 'Error reports, request metadata (IP, user agent) — no message content' },
];
...
export const COMPLIANCE_ROADMAP = {
  ...
  current: [
    ...
    { item: 'Formal verification — 26 TLA+ theorems, 35 Alloy facts + 22 assertions across two models (incl. 7 federation safety assertions) in CI', status: 'shipped', evidence: '/spec, repo formal/ directory' },
