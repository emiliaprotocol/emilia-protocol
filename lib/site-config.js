...
export const ENTITY = {
  ...
  // Public site shows city/state only. Full street address, phone, and EIN
  // live on procurement / SAM.gov forms — NEVER in this public file (public repo).
  address: 'Glendale, California, USA — full mailing address on request',
