// Generated from policy-defaults.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
export const DEFAULTS = Object.freeze({
    ...
    EITHER_FINE_TUNE_DISCLOSURE_A_OR_B: 'We do not fine-tune foundation models on customer data. Any future fine-tuning would be opt-in and separately disclosed.',
    EVIDENCE_CUSTODY_PROCEDURE: 'Evidence is collected to a write-once store with documented chain of custody.',
...
function regionFromCloud(cloud) {
    ...
    if (/eu|frankfurt|ireland|europe/.test(c))
        return { primary: 'eu-central-1', country: 'European Union' };
    if (/ap-|asia|tokyo|singapore|sydney/.test(c))
        return { primary: 'ap-southeast-1', country: 'Asia-Pacific' };
