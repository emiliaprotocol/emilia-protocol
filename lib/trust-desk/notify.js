// Generated from notify.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
export async function notifyPublished({ engagement, slug, trustUrl, }) {
    ...
    const body = `Your AI Trust Desk packet is published and live at:\n\n${trustUrl}\n\n` +
...
export async function notifyEscalated({ engagement, reason, etaHours = 4, }) {
    ...
    const body = `Thanks — your questionnaire is in. A named reviewer is finishing the parts ` +
        `our automated pipeline flagged for human attention. Expected delivery: within ` +
        `${etaHours} business hours.\n\n— AI Trust Desk`;
    await slackPing(`:warning: Escalated *${engagement?.engagement_id}* (${reason}) — reviewer SLA ${etaHours}h`);
    return sendEmail({ to, subject, body });
}
