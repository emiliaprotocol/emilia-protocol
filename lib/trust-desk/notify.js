...
async function sendEmail({ to, subject, body }) {
  ...
  try {
    ...
    logger.warn('trust-desk notify: email threw', { error: err.message });
    return { channel: 'email', delivered: false, detail: err.message };
  }
}
...
async function slackPing(text) {
  ...
  try {
    ...
    logger.warn('trust-desk notify: slack threw', { error: err.message });
    return { channel: 'slack', delivered: false, detail: err.message };
  }
}
