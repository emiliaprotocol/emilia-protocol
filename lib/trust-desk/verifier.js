// Generated from verifier.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
export function verifyAnswer(answer, ctx = {}) {
    ...
    if (SSN_RE.test(text))
        failures.push({ gate: 'no_pii_leak', detail: 'SSN pattern present' });
...
export function verifyEngagement(answers, ctx = {}) {
    ...
    if (failed === 0)
        decision = 'auto';
    else if (failRate <= FULL_ESCALATION_FAIL_RATE)
        decision = 'partial';
    else
        decision = 'full';
    return {
