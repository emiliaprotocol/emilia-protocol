...
/**
 * Mint all 5 policy docs for an engagement.
 * @param {object} opts
 * @param {object} opts.intake
 * @param {string} opts.slug
 * @param {string} opts.outDir  directory to write policy markdown into
 * @param {string} [opts.effectiveDate]
 * @returns {Array<{doc_id,title,filename,path,content_hash,bytes}>}
 */
