// Generated from page-verify.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
function verifyDoc(doc, getArtifact) {
    ...
    const claims = (doc.claims || []).map((claim) => {
        ...
        if (raw == null) {
            ...
            const recomputed = claim.category === 'questionnaire' ? hashClaim(safeJson(raw)) : hashText(raw);
