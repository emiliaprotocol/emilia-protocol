...
const d = (urn: any) => DESCRIPTOR_BY_URN[urn];
...
registerProfile('urn:ep:profile:revocation:v1', ({
  descriptor: d('urn:ep:profile:revocation:v1'),
  validateBody: (env: any, opts: any = {}) =>
...
registerProfile('urn:ep:profile:eye-set:v1', ({
...
registerProfile('urn:ep:profile:execution-integrity:v1', ({
...
registerProfile('urn:ep:profile:wysiwys:v1', ({
...
registerProfile('urn:ep:profile:provenance-chain:v1', ({
  descriptor: d('urn:ep:profile:provenance-chain:v1'),
  validateBody: (env: any, opts: any = {}) => verifyProvenanceOffline(env.payload, opts as any),
}) as any);
...
registerProfile('urn:ep:profile:resolution:v1', ({
  descriptor: d('urn:ep:profile:resolution:v1'),
  validateBody: (env: any, opts: any = {}) => verifyResolutionReceipt(env.payload, {
