 ...
 * the replacer array is used as a whitelist that applies at every nesting
 * level, so nested properties whose names don't appear at the top level
 * are silently dropped. deepSortKeys avoids this by rebuilding the object
 * tree with sorted keys before serialization.
 *
 * @param {unknown} value
