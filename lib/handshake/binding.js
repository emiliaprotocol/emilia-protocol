 ...
 * @property {number} binding_material_version - Version of the binding material schema
 */
 ...
 *
 * @param {unknown} value
 * @returns {unknown} The canonicalized value.
...
export function deepSortKeys(value) {
  ...
  if (typeof value === 'object') {
    ...
    const entries = Object.keys(object).map((k) => [k.normalize('NFC'), deepSortKeys(object[k])]);
