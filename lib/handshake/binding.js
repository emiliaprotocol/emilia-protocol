 ...
 *
 * @param {object} params
 * @param {string} params.action_type - Required. The action being bound.
 ...
 * @returns {object} The canonical binding material object.
 */
 ...
 *
 * @param {object} binding - The binding material object.
 ...
 *
 * @param {object} binding - The binding material object.
 * @returns {string} Hex-encoded SHA-256 hash (the binding_hash).
 */
 ...
 *
 * @param {object} binding - The binding material object.
 * @throws {Error} BINDING_INVARIANT_VIOLATION if validation fails.
 */
