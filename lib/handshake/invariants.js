// Generated from invariants.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
export function checkNoDuplicateResult(existingResults, bindingHash) {
    ...
    const duplicate = existingResults.find((r) => r.outcome === 'accepted' && r.binding_hash === bindingHash);
    if (duplicate) {
...
export function runAllInvariants(context) {
    const { handshake = {}, parties = [], presentations = [], binding = null, policy = null, authorities = [], existingResults = [], existingResult = null, verificationPayloadHash = null, authenticatedEntity = null, } = context || {};
