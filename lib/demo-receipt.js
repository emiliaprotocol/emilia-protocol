...
// Generated from demo-receipt.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
function getRuntimeKeypair() {
    ...
    if (isProduction()) {
        const error = new Error('EP_DEMO_SIGNING_KEY is required in production for dynamic demo receipts; refusing to sign with source or an implicit fallback.');
