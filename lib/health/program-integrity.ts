...
function validateInput(input: any): { values: any; status: Record<string, string>; failures: string[] } {
...
function buildAction(values: any): any {
  return {
    action_type: ACTION_TYPE,
    operation_id: values.operationId,
    provider_npi: values.providerNpi,
 ...
 * @returns {any}
 */
function buildEvidenceSummary(status: any, capability: string = 'uncommitted', providerEvidence: any = undefined): any {
  return {
...
function stateFor(input: any, options: any): any {
...
function providerOutcome(input: any, options: any): string | null {
...
function normalizeObservedAction(observed: any): any {
...
function buildProviderEvidence(action: any, caid: any, actionDigest: any): any {
  const body = {
...
function verifyProviderEvidence(evidence: any, action: any, caid: any, actionDigest: any): { evidenceDigest: string } | null {
...
function operationSummary(prepared: any, operation: any, reasonCodes: any[] = []): any {
 ...
 */
export function createSyntheticHospiceScenario(overrides: any = {}): any {
  const base = {
 ...
 */
export function evaluateHospiceProgramIntegrity(input: any, options: any = {}): any {
 ...
 */
export function reconcileHospiceProgramIntegrity(input: any, options: any = {}): any {
  const prepared = prepare(input, options);
  if (prepared.summary) return prepared.summary;
  const state = stateFor(input, options);
...
function findProhibitedPhi(value: any): string | null {
...
function statefulEvidenceSummary(overrides: any = {}): any {
  return {
    status: 'satisfied',
...
function validateStatefulAction(action: any, {
...
function computeStatefulActionBinding(action: any, options: {
  profileId?: string;
  actionType?: string;
  permitCallerCaid?: boolean;
} = {}): any {
...
function packetDigest(packet: any): string {
 ...
 */
export function verifyProgramIntegrityEvidencePacket(packet: any): { valid: boolean; reasons: string[] } {
  const refuse = (): { valid: boolean; reasons: string[] } => ({ valid: false, reasons: ['evidence_packet_ambiguous'] });
  if (!isRecord(packet)
...
export function createProgramIntegrityEngine(config: any = {}): any {
  ...
  async function readOperation(operationId: any): Promise<any> {
  ...
  async function writeOperation(operationId: any, operation: any): Promise<boolean> {
  ...
  async function prepareStateful({ action }: { action?: any } = {}): Promise<any> {
