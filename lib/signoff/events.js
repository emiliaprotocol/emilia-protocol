 ...
 *
 * @param {object} params
 * @param {string|null} [params.handshakeId] - The originating handshake (optional)
 * @param {string|null} [params.challengeId] - The signoff challenge ID
 * @param {string|null} [params.signoffId] - The signoff attestation ID
