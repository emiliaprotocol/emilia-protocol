 ...
 * @param {string|null} [params.channel] - Channel through which attestation was made
 * @param {string|null} [params.expiresAt] - ISO-8601 attestation expiry deadline
 * @param {string|null} [params.attestationHash] - Hash of the attestation payload
 * @param {object} [params.metadata] - Additional metadata
 * @param {{entity_id?: string}|null} [params.actor] - Authenticated accountable actor
