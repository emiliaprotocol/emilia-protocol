 ...
 * @param {string} [params.signoffPolicyHash] - SHA-256 of policy rules at issuance time
 * @param {string} params.requiredAssurance - Minimum assurance level required
 * @param {string[]} params.allowedMethods - Authentication methods permitted
 * @param {string} params.expiresAt - ISO-8601 challenge expiry deadline
 * @param {object} [params.metadata] - Additional metadata
 * @returns {Promise<object>} The created challenge record
 */
