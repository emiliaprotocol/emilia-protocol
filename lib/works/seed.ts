...
export const SEED_CARDS: CapabilityCardRecord[] = [
  {
    ...
    listing_id: 'ep-conformance-catalog',
    claim: {
      statement: 'The conformance manifest records 21 suites and 335 vectors with status "pass" for 3 same-team reference implementations (JavaScript, Python, Go).',
      status: 'VERIFIED',
  ...
  },
  {
    ...
    listing_id: 'ep-conformance-catalog',
    claim: {
      statement: 'A maintainer run of `npm run check:public-conformance-claims` at this revision reported PASS: 21 suites, 335 vectors, 359 external hostility cases; 8854 automated test cases across 532 files.',
      status: 'ASSERTED',
