...
/**
 * Revoke all active approver credentials for a SCIM-managed identity.
 * Returns the number of credentials revoked (0 when the human never enrolled).
 */
export async function revokeApproverCredentials(supabase, tenantId, userName, reason) {
