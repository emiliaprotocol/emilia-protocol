...
export const VALID_EYE_STATUSES: Set<string> = new Set(EYE_STATUSES);
export const VALID_EYE_POLICY_ACTIONS: Set<string> = new Set(EYE_POLICY_ACTIONS);
export const VALID_EYE_SEVERITY_HINTS: Set<string> = new Set(EYE_SEVERITY_HINTS);
export const VALID_EYE_OBSERVATION_TYPES: Set<string> = new Set(EYE_OBSERVATION_TYPES);
export const VALID_EYE_CONFIDENCE_CLASSES: Set<string> = new Set(EYE_CONFIDENCE_CLASSES);
