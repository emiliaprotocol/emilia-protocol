...
export async function createPairing(supabase, { code, entityRef, approverId, profileId, allowedApps, expiresAt, sessionExpiresAt, }) {
...
export async function exchangePairing(supabase, { code, token, platform, appId }) {
    ...
    if (error)
        throw databaseError('mobile pairing exchange failed', error);
