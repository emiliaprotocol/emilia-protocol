...
export async function findVouchers(disputedEntityId, supabase) {
  ...
  // confidence_score DESC, then entity_id UUID lexicographically as a final
  // deterministic tiebreaker. Without the UUID tiebreaker, equal-ranked vouchers
  // have undefined relative order, making accumulation results DB-row-order dependent.
  vouchers.sort((a, b) => {
