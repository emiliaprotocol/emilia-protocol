 ...
 * @returns {Promise<{ok: true, text: string} | {ok: false, status: number, code: string, detail: string}>}
 */
 ...
 * @param {{ emptyValue?: object, invalidValue?: * }} [opts]
 * @returns {Promise<{ok: true, value: any, status?: undefined, code?: undefined, detail?: undefined} | {ok: false, status: number, code: string, detail: string, value?: undefined}>}
 */
