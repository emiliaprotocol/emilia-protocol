...
/**
 * Assurance-tier quorum enforcement at consume. When enabled, a 'dual' value tier
 * (e.g. payment >= $1M) requires TWO distinct, individually-authorized Class-A
 * approvals before consume, not one. Default OFF for safe rollout — enable in
 * gov/high-assurance deployments first. See
 * docs/gov-readiness/ASSURANCE-TIER-ENFORCEMENT.md.
 */
export function isTierQuorumEnforced() {
  return process.env.EP_TIER_QUORUM_ENFORCE === 'true';
}
