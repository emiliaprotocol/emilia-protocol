...
export function getGovVerifierConfig() {
  ...
  return {
    ...
    // for any production build. The public instance is NODE_ENV=production but is
    // a developer playground (self-signed receipts on /api/v1/guarded power the
    // 10-minute wedge); a government deployment opts into strict + pinned keys.
    // Auto-enabling on isProduction() would 503 the live guarded endpoint.
