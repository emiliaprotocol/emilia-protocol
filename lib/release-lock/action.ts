...
function validText(value: any, max: number = 512): boolean {
...
function validateDocumentEvidence(value: any, expected: any): any {
...
function actionContext(lockId: any, version: any, createdAt: any): void {
