...
export const RELEASE_LOCK_ROLES = Object.freeze(['contractor', 'customer']);
export const RELEASE_LOCK_ROUNDS = Object.freeze([
  'CO_ACCEPTED',
  'DRAW_RELEASE',
]);
...
export const RELEASE_LOCK_LIMITATIONS = Object.freeze([
