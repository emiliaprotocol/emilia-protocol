...
/**
 * @param {object} materialScope
 * @param {object} opts
 * @param {string|undefined} opts.lockId
 * @param {number|undefined} opts.version
 * @param {string|undefined} opts.createdAt
 * @param {string|null} [opts.effectReference]
 */
