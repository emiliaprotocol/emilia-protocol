...
/**
 * @param {object} [opts]
 * @param {{ lock_id: string, role: string, contact_binding_id: string, expires_at: string, lock_expires_at: string }} [opts.session]
 * @param {Array<{ credential_id: string, transports?: string[] }>} [opts.existingCredentials]
 * @param {(() => number) | number} [opts.now]
 * @param {object} [opts.rpConfig]
 */
export async function createReleaseLockRegistrationOptions({
  ...
  const options = await generateRegistrationOptions({
    ...
    excludeCredentials: /** @type {*} */ (existingCredentials.map((credential) => ({
...
/**
 * @param {object} [opts]
 * @param {{ challenge: string, rp_id: string, origin: string }} [opts.challenge]
 * @param {object} [opts.attestation]
 * @param {object} [opts.rpConfig]
 */
