 ...
 * @param {string} [params.contactBindingId]
 * @param {string} [params.contractorEntityId]
 * @param {string} [params.credentialId]
 * @param {*} [params.action]
 * @param {string} [params.actionHash]
 * @param {string|null} [params.authorizationExpiresAt]
 * @param {() => number} [params.now]
 * @param {typeof import('node:crypto').randomBytes} [params.randomBytes]
 * @param {typeof import('node:crypto').randomInt} [params.randomInt]
 */
 ...
 * @param {*} [params.submittedAnswers]
 * @param {*} [params.assertion]
 * @param {*} [params.credential]
 * @param {string} [params.rpId]
 * @param {string[]} [params.allowedOrigins]
 * @param {Date} [params.evaluationTime]
 */
