 ...
 * 
 * @param {Record<string, number>} receipt - { delivery_accuracy, product_accuracy, price_integrity, return_processing, agent_satisfaction }
...
// =============================================================================
/**
 * @typedef {'delivery_accuracy'|'product_accuracy'|'price_integrity'|'return_processing'|'agent_satisfaction'} SignalKey
 */
/**
 * @typedef {Object} ScoringReceipt
 * @property {number} [delivery_accuracy]
 * @property {number} [product_accuracy]
 * @property {number} [price_integrity]
 * @property {number} [return_processing]
 * @property {number} [agent_satisfaction]
 * @property {number} [composite_score]
 * @property {number|null} [submitter_score]
 * @property {boolean} [submitter_established]
 * @property {string|number|Date|null} [created_at]
 * @property {number} [graph_weight]
 ...
 *
 * @param {Array<ScoringReceipt>} receipts - Array of receipt objects, most recent first
...
export function computeEmiliaScore(receipts) {
  ...
  for (const signal of Object.keys(EMILIA_WEIGHTS)) {
    ...
    for (let i = 0; i < window.length; i++) {
      const value = window[i][/** @type {SignalKey} */ (signal)];
 ...
 * 
 * @param {number|null|undefined} submitterScore - The submitter's EMILIA score (0-100)
 * @param {boolean|undefined} submitterEstablished - Whether submitter has 5+ receipts from 3+ submitters
 ...
 * 
 * @param {string|number|Date|null|undefined} createdAt - Receipt creation timestamp
 ...
 * @param {number} emiliaScore - 0-100, entity's compatibility score
...
// =============================================================================
/**
 * @typedef {Object} DeliveryOnTimeDetail
 * @property {string|number|Date} [promised]
 * @property {string|number|Date} [actual]
 */
/**
 * @typedef {Object} PriceHonoredDetail
 * @property {number} [quoted]
 * @property {number} [charged]
 * @property {number} [quoted_cents]
 * @property {number} [charged_cents]
 */
/**
 * @typedef {Object} ReceiptClaims
 * @property {boolean} [delivered]
 * @property {boolean|DeliveryOnTimeDetail} [on_time]
 * @property {boolean} [as_described]
 * @property {boolean|PriceHonoredDetail} [price_honored]
 * @property {boolean} [return_accepted]
 */
/**
 ...
 *
 * @param {ReceiptClaims} claims - Structured claims from v2 receipt
 ...
 *
 * @param {*} obj - any JSON-compatible value (recurses into arrays/objects)
 * @returns {string}
 */
 ...
 * @property {number} [return_processing]
 * @property {number} [agent_satisfaction]
 * @property {string} [agent_behavior]
 * @property {ReceiptClaims} [claims]
 * @property {*} [evidence]
 * @property {number} [submitter_score]
 * @property {boolean} [submitter_established]
 */
/**
 ...
 *
 * @param {FullReceipt} receipt - the receipt data
