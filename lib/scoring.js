 ...
 * 
 * LEGACY: This engine computes a 0-100 compatibility score.
 * For trust decisions, use lib/scoring-v2.js (trust profiles + policy evaluation).
 * 
 * This file also contains the canonical receipt hashing function (computeReceiptHash)
 * which is used across all versions.
 * 
 * @license Apache-2.0
 */
