...
export function buildActionStateCapsule({ action, operator, developer, timestamp, dispatchRequestDigest, meterDigest, authorizationDigest, } = {}) {
...
export async function executeGraceCurtailment({ action, envelope, spent = {}, presentation, policy, authorizationEvidence, authorizationProfile, executionStore, actuator, actuatorTrust, meter, meterTrust, settlementStore, settle, operator, developer = 'cosa-reference-adapter/1.0', capsuleSigner, clock = () => new Date().toISOString(), } = {}) {
