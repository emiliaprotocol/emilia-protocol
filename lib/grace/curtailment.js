 ...
 */
export function checkOrderWithinEnvelope(order, envelope) {
  const violations = [];
  ...
  else if (!Number.isFinite(maxMw) || mw > maxMw) violations.push(`order: ${mw} MW exceeds envelope max ${maxMw} MW`);
