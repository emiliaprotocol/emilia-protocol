 ...
 * @param {object} opts
 * @param {boolean} opts.isCritical  whether this action fails closed under enforce_critical
 * @param {string} opts.mode         one of AUTHORITY_ENFORCEMENT_MODES (server-pinned)
