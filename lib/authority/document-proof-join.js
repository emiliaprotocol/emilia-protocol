...
// Generated from document-proof-join.ts by scripts/build-standalone-runtimes.mjs. Do not edit.
/**
 ...
 */
import { authorityInstantMs, docCoreDigest, isStableAuthorityIdentifier, resolveIssuerKeyAt, verifyAuthorityChain, } from './authority-doc.js';
...
export function verifyAuthorityProofViaDocument(proof, docs, opts = {}) {
    ...
    if (!(Number.isSafeInteger(proof.registry_epoch)
        && proof.registry_epoch >= opts.expectMinEpoch)) {
