  ...
  return <div className={styles.page}>
    ...
    <main className={styles.main}>
      <header className={styles.hero}>
        <p className={styles.eyebrow}>EMILIA Marketplace · Qualification</p>
        <h1>Qualified for which job?</h1>
        <p className={styles.lead}>A useful result names the agent, the assignment and the tests behind it. Change any of those, and the old result is not enough.</p>
        <p>A free scan helps you inspect declared tools. Qualification checks signed evidence against a test policy and the operator’s latest trusted status observation. Neither step gives the agent permission to act.</p>
      </header>
      <section className={styles.explanation} aria-labelledby="qualification-scope-title">
