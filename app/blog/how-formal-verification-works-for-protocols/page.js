  ...
  return (
    <div style={styles.page}>
      ...
      <section style={{ ...styles.section, paddingTop: 0, paddingBottom: 48 }}>
        ...
        <p className="ep-reveal" style={styles.body}>
          Bounded scope sounds like a weakness; it is also a feature. The "small scope hypothesis" — that most invariant violations show up in small instances — has held remarkably well in practice. EMILIA's Alloy model has 35 facts (e.g., {inline('OneBindingPerHandshake')}, {inline('ConsumedRequiresVerifiedEvent')}, {inline('SignoffChallengeBindingMatchesHandshake')}) and 22 assertions. Three of those assertions failed during initial development and surfaced real protocol gaps; fixing them added the facts that now keep the assertions true.
        </p>
      </section>
