...
export const metadata = {
  ...
  title: 'draft-schrock-ep-authorization-receipts-10 — EMILIA Protocol Specification',
...
export default function SpecPage() {
  const draftPath = join(process.cwd(), 'standards', 'posted', 'draft-schrock-ep-authorization-receipts-10.xml');
  ...
  return (
    <div className={SPEC_FONT_CLASS}>
      ...
      <div className="spec-content">
        ...
        <div className="spec-badge">DRAFT-SCHROCK-EP-AUTHORIZATION-RECEIPTS-10 · STANDARDS TRACK CANDIDATE · IETF INDIVIDUAL SUBMISSION · APACHE 2.0</div>
        ...
        <div className="spec-footer">
          EMILIA Protocol — draft-schrock-ep-authorization-receipts-10 — Apache 2.0 License
        </div>
      </div>
      <SiteFooter />
    </div>
