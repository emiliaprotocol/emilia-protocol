 ...
 * `useState(null)`.
 * @typedef {Object} GraceReferenceScenario
 * @property {boolean} ok
 * @property {boolean} reference_only
 * @property {boolean} physical_claim
 * @property {string} description
 * @property {{target_delta_kw: string, [key: string]: *}} action
 * @property {string} action_hash
 * @property {{valid: boolean, checks: Object<string, boolean>, members: Array<*>}} authorization
 * @property {{adapter?: string, request_digest?: string, [key: string]: *}} acknowledgment
 * @property {{baseline_mw: string, intervals: Array<{at: string, load_mw: string}>, measurement_class?: string, [key: string]: *}} meter_statement
 * @property {{delivered_mw?: number, compliance_ratio: number, compliant: boolean, [key: string]: *}} compliance
 * @property {{capsule?: {capsule_id?: string}, [key: string]: *}} action_state
 * @property {{settled: boolean, key: *, result: *}} settlement
 * @property {{replay: {refused: boolean, verdict: string}, action_substitution: {refused: boolean, verdict: string}, meter_rule_smuggling: {refused: boolean, verdict: string}}} attacks
 * @property {*} [pins]
 */
...
export default function GraceLiveConsole() {
  const [data, setData] = useState(/** @type {GraceReferenceScenario|null} */ (null));
    ...
    <main className={styles.page}>
      ...
      <section className={styles.attackSection} data-testid="grace-attacks">
        ...
        <div className={styles.attackGrid}>
          {/** @type {Array<[string, string, string, {refused: boolean, verdict: string}|undefined]>} */ ([
