...
function SlideLabel({ number, children }: SlideLabelProps): React.ReactElement {
  return (
...
function ScreenshotFrame({ src, alt, className = '' }: ScreenshotFrameProps): React.ReactElement {
  return (
...
export default function GraceScreenshotStory(): React.ReactElement {
