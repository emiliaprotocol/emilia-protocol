...
function StatusBadge({ value }: { value: string }) {
  const c = STATUS_COLORS[value as keyof typeof STATUS_COLORS] || STATUS_COLORS.allow;
  return (
    <span style={{
...
function RiskChip({ code }: { code: string }) {
  return (
    <span style={{
...
type PageParams = { params: Promise<{ receiptId: string }> };
