...
const s = {
  ...
  card: {
    ...
    padding: '32px 28px', textDecoration: 'none', color: '#f0f2f5',
  ...
  cardDesc: { fontSize: 14, color: '#8b95a5', lineHeight: 1.65, marginBottom: 16 },
  cardLink: { fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 13, fontWeight: 500, color: '#d4af55' },
};
        ...
        <div style={s.grid}>
          {USE_CASES.map(uc => (
            <a key={uc.href} href={uc.href} style={s.card}
              onMouseEnter={e => { e.currentTarget.style.background = '#1a2238'; e.currentTarget.style.borderTopColor = '#d4af55'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = '#111827'; e.currentTarget.style.borderTopColor = 'transparent'; e.currentTarget.style.transform = 'translateY(0)'; }}
            >
