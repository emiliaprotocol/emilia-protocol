        ...
        <div style={s.section}>
          ...
          {[
            ...
            <div key={i} style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 15, fontWeight: 700, color: '#f0f2f5', marginBottom: 4 }}>{w.title}</div>
              <div style={{ fontSize: 14, color: '#8b95a5', lineHeight: 1.65 }}>{w.body}</div>
            </div>
          ))}
        </div>
      </section>
