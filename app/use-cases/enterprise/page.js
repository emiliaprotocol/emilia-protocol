  ...
  return (
    <div style={styles.page}>
      ...
      <section style={{ ...styles.section, paddingTop: 100, paddingBottom: 60 }}>
        <div style={styles.eyebrowBlue}>Use Case / Enterprise</div>
        <h1 style={styles.h1}>Action-level control for high-risk enterprise operations</h1>
        ...
        <div style={styles.section}>
          ...
          {[
            ...
            <div key={i} style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: font.sans, fontSize: 15, fontWeight: 700, color: color.t1, marginBottom: 4 }}>{w.title}</div>
      ...
      <section style={{ textAlign: 'center' }}>
        <div style={{ ...styles.section, maxWidth: 540, paddingTop: 60, paddingBottom: 60 }}>
          <h2 style={{ ...styles.h2, fontSize: 28 }}>Trust before high-risk action in enterprise operations</h2>
          <p style={styles.body}>
