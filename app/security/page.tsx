    ...
    <div style={styles.page}>
      ...
      <section style={{ ...styles.section, paddingTop: 0, paddingBottom: 56 }}>
        ...
        <ul className="ep-reveal" style={styles.list}>
          <li><strong style={{ color: color.t1 }}>Not a proof of model behavior.</strong> The checked invariants constrain what the modeled protocol <em>allows</em>, not what an AI model <em>attempts</em>. They say nothing about whether an LLM makes good decisions &mdash; only what the modeled gate permits under its stated assumptions.</li>
