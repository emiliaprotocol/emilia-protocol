...
export default function BreakTheCeremonyPage(): React.ReactElement {
  return (
    <div style={styles.page}>
        ...
        <div style={{ marginTop: 24, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
          {GUARANTEES.map((g, i) => (
            <motion.div
              key={g.invariant}
              {...reveal(i * 0.05)}
              style={{ border: `1px solid ${color.border}`, borderRadius: radius.base, background: color.card, padding: 20 } as React.CSSProperties}
            >
      ...
      <section style={styles.section}>
        ...
        <div style={{ marginTop: 24, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
          <motion.div {...reveal(0.05)} style={{ border: `1px solid ${color.border}`, borderTop: `3px solid ${color.green}`, borderRadius: radius.base, background: color.card, padding: 22 } as React.CSSProperties}>
          ...
          <motion.div {...reveal(0.1)} style={{ border: `1px solid ${color.border}`, borderTop: `3px solid ${color.t3}`, borderRadius: radius.base, background: color.card, padding: 22 } as React.CSSProperties}>
      ...
      <section style={styles.section}>
        ...
        <motion.div {...reveal(0.05)} style={{ marginTop: 22, border: `1px solid ${color.border}`, borderRadius: radius.base, overflow: 'hidden' } as React.CSSProperties}>
      ...
      <section style={styles.section}>
        <motion.div {...reveal()} style={{ border: `1px solid ${color.gold}`, background: '#FFFBEB', borderRadius: radius.base, padding: '24px 26px' } as React.CSSProperties}>
