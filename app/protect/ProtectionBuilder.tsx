      ...
      {plan ? (
        <section className={styles.result} aria-live="polite">
          ...
          <div className={styles.activation}>
            ...
            <code>npx --package @emilia-protocol/gate@0.23.17 ep-protect activate {plan.plan_id}.emilia-protection-plan.json --private-key owner.pem --tenant my-tenant --gateway my-mcp-gateway --authorizer my-owner --key-id owner-key-1 --out activation.json</code>
