      ...
      <section style={{ ...styles.section, paddingTop: 100, paddingBottom: 56, maxWidth: 760 }}>
        ...
        <div style={{ display: 'grid', gap: 18, marginTop: 32, marginBottom: 24 }}>
          {[
            ...
            ['The expansion', 'The same boundary applies when agents change cloud infrastructure, production code, permissions, payer records, treasury state, or industrial commands. Gate composes with native evidence rather than asking enterprises to replace identity, OAuth, policy, or workflow systems. For industrial paths, Gate composes with secure OT transport rather than replacing it: transport protects delivery, while Gate separately controls whether the exact action is admitted.'],
