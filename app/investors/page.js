...
export default function InvestorsPage() {
  ...
  const s = {
    ...
    highlight: { color: '#f0f2f5', fontWeight: 600 },
  };
    ...
    <div style={s.page}>
      ...
      <section style={{ ...s.section, paddingTop: 100, paddingBottom: 60 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <a href="#inquiry" style={{ ...s.cta, background: '#d4af55', color: '#0a0f1e' }}>Request Investor Materials</a>
          <a href="mailto:team@emiliaprotocol.ai" style={{ ...s.cta, background: 'transparent', color: '#d4af55', border: '1px solid rgba(212,175,55,0.3)' }}>Start a Conversation</a>
        </div>
        <p style={{ fontSize: 13, color: '#5a6577', marginTop: 16, maxWidth: 520 }}>
      ...
      <section style={s.sectionAlt}>
        <div style={s.section}>
          ...
          <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 20, fontWeight: 700, color: '#f0f2f5', lineHeight: 1.5, marginBottom: 24, borderLeft: '3px solid #d4af55', paddingLeft: 20 }}>
      ...
      <section style={s.section}>
        ...
        {['Trust should be action-bound', 'Trust should be policy-bound', 'Trust should be replay-resistant', 'Trust should be one-time consumable when used for authorization', 'Trust infrastructure should produce immutable event traceability'].map((p, i) => (
          <div key={i} style={{ display: 'flex', gap: 10, marginBottom: 8, alignItems: 'center' }}>
            ...
            <span style={{ fontSize: 15, color: '#8b95a5' }}>{p}</span>
          </div>
        ))}
      </section>
      ...
      <section style={s.sectionAlt}>
        <div style={s.section}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, marginBottom: 24 }}>
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Technical Moat</div>
            ...
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Replay Resistance</div>
            ...
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Compliance Layer</div>
            ...
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Accountability</div>
            ...
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Revenue Engine</div>
            ...
            <div style={s.card}>
              <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Vertical Pricing</div>
          ...
          <p style={{ fontSize: 15, color: '#8b95a5', lineHeight: 1.7 }}>
            <span style={{ color: '#f0f2f5', fontWeight: 600 }}>The moat is above open source.</span> Competitors can read the spec. They cannot replicate the canonical binding, the consumption model, the policy-versioning chain, or the accountability layer without rebuilding EMILIA from scratch. <span style={{ color: '#f0f2f5', fontWeight: 600 }}>Buyers pay because compliance and liability reduction are existential</span> — not optional. This is not standards work with a business model bolted on. It is a product that requires the protocol to function.
          </p>
        </div>
      </section>
          ...
          <div style={s.card}>
            {REVENUE.map((r, i) => (
              <div key={i} style={{ display: 'flex', gap: 10, marginBottom: i < REVENUE.length - 1 ? 10 : 0, alignItems: 'center' }}>
                <span style={{ color: '#d4af55', fontSize: 12, flexShrink: 0 }}>+</span>
                <span style={{ fontSize: 14, color: '#8b95a5' }}>{r}</span>
              </div>
            ))}
          </div>
          <p style={{ ...s.body, marginTop: 24, fontStyle: 'italic', color: '#5a6577' }}>
      ...
      <section style={s.section}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
          <div style={{ ...s.card, borderColor: 'rgba(212,175,55,0.2)' }}>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#4a90d9', marginBottom: 8, textTransform: 'uppercase' }}>Commitment Proofs</div>
          ...
          <div style={{ ...s.card, borderColor: 'rgba(212,175,55,0.2)' }}>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Auto-Receipt Generation</div>
          ...
          <div style={{ ...s.card, borderColor: 'rgba(212,175,55,0.2)' }}>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#3b9b6e', marginBottom: 8, textTransform: 'uppercase' }}>Delegation Judgment Score</div>
          ...
          <div style={{ ...s.card, borderColor: 'rgba(212,175,55,0.2)' }}>
            <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 2, color: '#d4af55', marginBottom: 8, textTransform: 'uppercase' }}>Trust-Graph Adjudication</div>
