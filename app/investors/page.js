...
export default function InvestorsPage() {
  ...
  const PROOF = [
    ...
    { title: 'Protocol + product coherence', body: 'Open protocol, open runtime, managed cloud, enterprise packs, vertical pricing. EP Core v1.0 frozen (PIP-001 accepted); CHANGELOG tracks the v1.1.0 maintenance line. 4,195 automated tests (static count; parameterized runs exceed this), 26 TLA+ theorems machine-verified (TLC 2.19, 0 errors), 85 red team cases cataloged in docs/conformance/RED_TEAM_CASES.md.' },
  ];
