...
export async function GET(request: Request): Promise<Response> {
  ...
  try {
    ...
    const authorization = proof.authorization as { valid: boolean; checks: object; quorum: { members: any } };
    const settlement = proof.settlement as { settled: boolean; key: any; result: any };
