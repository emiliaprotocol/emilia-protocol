...
import { POST as createTrustReceipt } from '@/app/api/v1/trust-receipts/route.js';
...
function delegatedRequest(url, authorization, body) {
...
async function relayJson(response) {
  let body;
  try {
