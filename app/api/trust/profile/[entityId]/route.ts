...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      description: (result._entity as any)?.description,
      category: result.category,
      capabilities: (result._entity as any)?.capabilities,
      ...
      member_since: (result._entity as any)?.created_at,
      _protocol_version: 'EP/1.1-v2',
    });
  } catch (err) {
