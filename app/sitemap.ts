...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const marketing = [
    ...
    { path: '/workforce',              priority: 0.99, changeFrequency: 'weekly' },
    ...
    { path: '/host',                  priority: 0.95, changeFrequency: 'weekly' },
    ...
    // Canonical four-document presentation surface. The two local document
    // routes sit directly behind /protocol; the other two point to Datatracker.
    { path: '/protocol',              priority: 0.95, changeFrequency: 'weekly' },
