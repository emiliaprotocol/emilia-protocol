/* Archived, non-routed evaluation source. Do not import into a public route. */
/* eslint-disable @next/next/no-location-assign-relative-destination -- historical source */
'use client';
...
// on production never lands on a 404. Same pattern as app/trust-desk/page.tsx.
...
export default function UploadPage() {
  ...
  function update(k: keyof FormState, v: string) { setForm((f) => ({ ...f, [k]: v })); }
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setEngagementId((data as any).engagement_id || null);
      setSubmitted(true);
      ...
      setError(`Submission failed: ${(err as Error).message}. Email team@emiliaprotocol.ai directly.`);
      setSubmitting(false);
    }
  }
