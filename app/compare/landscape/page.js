    ...
    <div style={styles.page}>
      ...
      <section style={{ ...styles.section, paddingTop: 0, paddingBottom: 56 }}>
        ...
        <ul className="ep-reveal" style={styles.list}>
          ...
          <li><strong style={{ color: color.t1 }}>Three independent implementations, proven interoperable.</strong> JavaScript, Python, and Go reference verifiers — written separately, sharing no code — agree on the canonical adversarial conformance vectors, re-proven on every push. That is the IETF bar for a real standard, and no one else in this landscape has demonstrated it. The vectors are public (<a href="https://github.com/emiliaprotocol/emilia-protocol/blob/main/CONFORMANCE.md" style={{ color: color.blue, textDecoration: 'none' }}>CONFORMANCE.md</a>) — any project here, including the ones above, is welcome to conform against them.</li>
