...
export default function CompareLandscapePage() {
  ...
  const ROWS = [
    ...
    { dim: 'Formal analysis', ep: '26 TLA+ invariants checked by TLC + 35 Alloy facts in CI, plus symbolic Dolev-Yao analysis in Tamarin', hl: 'No', tenet: 'No', drp: 'No — spec with 14 checks' },
