...
const s = {
  ...
  body: { fontSize: 16, color: '#8b95a5', lineHeight: 1.75, marginBottom: 32 },
  card: { background: '#111827', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 10, padding: '32px 28px', marginBottom: 16 },
  cardTitle: { fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 16, fontWeight: 700, marginBottom: 8 },
  cardDesc: { fontSize: 14, color: '#8b95a5', lineHeight: 1.65, marginBottom: 8 },
  link: { fontSize: 14, color: '#4a90d9', textDecoration: 'none' },
};
