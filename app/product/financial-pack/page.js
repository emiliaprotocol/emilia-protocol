  ...
  return (
    <div style={s.page}>
      ...
      <section style={{ ...s.section, paddingTop: 100, paddingBottom: 60 }}>
        ...
        <a href="#pilot" style={{ ...s.cta, background: '#22C55E', color: '#020617' }}>Request Financial Pilot</a>
      </section>
      ...
      <section style={s.section}>
        ...
        <div style={{ ...s.card, border: '1px solid rgba(212,175,55,0.2)' }}>
          <div style={{ ...s.cardTitle, color: '#22C55E', fontSize: 18, marginBottom: 10 }}>Beneficiary change</div>
