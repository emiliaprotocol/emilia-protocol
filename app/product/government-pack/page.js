  ...
  return (
    <div style={s.page}>
      ...
      <section style={{ ...s.section, paddingTop: 100, paddingBottom: 60 }}>
        ...
        <a href="#pilot" style={{ ...s.cta, background: '#ffd700', color: '#05060a' }}>Request Government Pilot</a>
      </section>
      ...
      <section style={s.section}>
        ...
        <div style={{ ...s.card, border: '1px solid rgba(255,215,0,0.2)' }}>
          <div style={{ ...s.cardTitle, color: '#ffd700', fontSize: 18, marginBottom: 10 }}>Payment destination change</div>
