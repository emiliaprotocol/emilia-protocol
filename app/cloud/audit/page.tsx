...
export default function AuditExportPage(): React.ReactElement {
  ...
  const s = {
    ...
    container: { maxWidth: 1080, margin: '0 auto', padding: '40px 24px' } as React.CSSProperties,
    ...
    h1: { fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 28, fontWeight: 700, letterSpacing: -0.5, marginBottom: 8 } as React.CSSProperties,
    ...
    label: { display: 'block', fontSize: 12, fontWeight: 600, color: '#7a809a', marginBottom: 6, fontFamily: "'IBM Plex Mono', monospace", letterSpacing: 0.5 } as React.CSSProperties,
    input: { width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: '#0F172A', color: '#e8eaf0', fontSize: 14, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box' } as React.CSSProperties,
    select: { width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid rgba(255,255,255,0.08)', background: '#0F172A', color: '#e8eaf0', fontSize: 14, fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box', appearance: 'none' } as React.CSSProperties,
    btn: { padding: '10px 24px', borderRadius: 8, fontFamily: "'IBM Plex Mono', monospace", fontSize: 12, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', border: 'none', cursor: 'pointer' } as React.CSSProperties,
    mono: { fontFamily: "'IBM Plex Mono', monospace", fontSize: 12 } as React.CSSProperties,
    th: { padding: '10px 14px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: '#4a4f6a', fontFamily: "'IBM Plex Mono', monospace", letterSpacing: 1, textTransform: 'uppercase', borderBottom: '1px solid rgba(255,255,255,0.06)' } as React.CSSProperties,
    td: { padding: '10px 14px', fontSize: 13, borderBottom: '1px solid rgba(255,255,255,0.03)' } as React.CSSProperties,
  };
