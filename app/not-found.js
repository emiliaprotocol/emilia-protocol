      ...
      <head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box}
          body{background:#000000;color:#f0f4ff;font-family:'IBM Plex Sans',sans-serif;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:40px 24px}
          ...
          .code{font-family:'IBM Plex Mono',monospace;font-size:80px;font-weight:700;color:rgba(96,165,250,0.15);line-height:1;margin-bottom:16px}
