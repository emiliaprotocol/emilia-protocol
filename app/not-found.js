      ...
      <head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box}
          body{background:#000000;color:#f0f4ff;font-family:'Outfit',sans-serif;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:40px 24px}
          .logo{font-family:'JetBrains Mono',monospace;font-size:12px;letter-spacing:3px;color:#475569;text-transform:uppercase;margin-bottom:48px}
          .code{font-family:'JetBrains Mono',monospace;font-size:80px;font-weight:700;color:rgba(96,165,250,0.15);line-height:1;margin-bottom:16px}
          ...
          a{font-family:'JetBrains Mono',monospace;font-size:11px;letter-spacing:1px;text-transform:uppercase;text-decoration:none;padding:10px 20px;border-radius:8px;transition:all .2s}
