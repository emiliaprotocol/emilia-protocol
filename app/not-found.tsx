      ...
      <head>
        ...
        <style>{`
          *{margin:0;padding:0;box-sizing:border-box}
          body{background:#020617;color:#f0f4ff;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:40px 24px}
          .logo{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:12px;letter-spacing:3px;color:#475569;text-transform:uppercase;margin-bottom:48px}
          .code{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:80px;font-weight:700;color:rgba(59,130,246,0.15);line-height:1;margin-bottom:16px}
          ...
          a{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:11px;letter-spacing:1px;text-transform:uppercase;text-decoration:none;padding:10px 20px;border-radius:8px;transition:all .2s}
