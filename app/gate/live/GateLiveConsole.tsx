...
function stageSentence(stage: string, data: GateLiveData | null): string {
...
function Status({ pass, children }: StatusProps): React.ReactElement {
...
export default function GateLiveConsole(): React.ReactElement {
  const [profile, setProfile] = useState<string>('treasury');
  const [data, setData] = useState<GateLiveData | null>(null);
