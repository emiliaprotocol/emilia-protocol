...
// Generated from no-raw-auth-entity.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
const noRawAuthEntity = {
    meta: {
        ...
        schema: [],
        messages: {
            rawAuthEntity: 'SECURITY: auth.entity is an entity row, not a caller identity. Use authEntityId(auth) for authorization comparisons.',
        },
    },
    create(context) {
        ...
        return {
            ...
            VariableDeclarator(node) {
                if (!isAuth(node.init) || node.id?.type !== 'ObjectPattern')
                    return;
            ...
            AssignmentExpression(node) {
                if (!isAuth(node.right) || node.left?.type !== 'ObjectPattern')
                    return;
