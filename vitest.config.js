  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'lib/verify-web.js',
        // Generated byte-for-runtime copy of the TypeScript Procore adapter.
        // Source behavior is covered by tests/action-escrow-procore.test.js;
        // generated-byte sync and the complete Node 20 demo are separately
        // gated by examples/action-escrow/standalone.test.mjs in gate-product.
