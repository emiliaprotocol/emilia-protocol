...
| Revocation inheritance | `ep_capability_revocation.tla`: `CascadeRevocationClosesDescendants`, `DirectRevocationDoesNotRetractTransferredAuthority`, `NewReservationRequiresCurrentCompleteLineage`, `OwnedReservationNeverReopens` | Cascade revocation closes later descendant admission; direct revocation preserves already transferred descendant authority; missing lineage fails closed; a reservation owned before revocation does not reopen. |
