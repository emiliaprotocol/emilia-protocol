...
| Standards — I-Ds. **POSTED on datatracker (verified 2026-06-26): authorization-receipts -02 + quorum -01 + authorization-evidence-chain -00 (EP-AEC, 2026-06-22).** Written + render-clean + staged-to-file (NOT yet posted): architecture, receipts-03 (revision over -02), enforcement-point, evidence-record, emilia-eye, grid-curtailment, pqc, agent-trust-stack, human-oversight-profile. Zenodo DOI. | submission gated on Iman's datatracker upload per `docs/standards-engagement/SUBMIT-2026-06-28.md`; field map `docs/strategy/AGENT-AUTHORIZATION-LANDSCAPE-2026.md`; engagement drafts `docs/engagement/` (NIST NCCoE, AUDIT-BOF) | `/spec`, datatracker |
