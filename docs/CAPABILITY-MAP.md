...
**The canonical "what we actually have."** Last audited: 2026-06-21.
...
| Revocation (portable offline statement + server-state) | code + spec | `lib/revocation/`, `lib/signoff/revoke.js`, `docs/EP-REVOCATION-SPEC.md` | — (not yet in the verify CLI) |
...
| Auditor-specific observe-report shaping; SCIM; PIV/CAC/Login.gov | Build WITH the first auditor/customer |
