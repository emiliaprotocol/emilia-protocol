...
- **Open source protocols**: The canonical implementation is fully open source. MCP server (15 tools, context-aware) and a conformance-backed reference implementation are published. 7 suites and 147 automated checks cover core protocol behavior, plus cross-language verification in Python.
