...
3. **Formal verification:** 26 TLA+ safety properties verified (T1–T26, TLC 2.19, 413,137 states, 0 errors) — includes the EP-IX identity continuity invariants (T21–T26). 35 Alloy relational facts + 22 assertions verified (Alloy 6.0.0, 0 counterexamples). All run in CI.
