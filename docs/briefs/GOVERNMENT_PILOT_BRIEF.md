...
- **21 suites / 335 vectors across three same-team language ports**, plus a separately authored Rust verifier rebuilt from pinned public source and tested against 359 hostile cases — external interoperability evidence a relying party can reproduce without trusting the vendor.
...
- 7,000+ automated Vitest cases across 370+ files, with all platform-applicable cases required to pass; Stryker.js mutation gate ≥90%; property-based and linearizability testing included
- 86 red team cases documented; repository checks pass; Strix reports all 24 STRIX-25 through STRIX-48 targeted retests `Fixed`, with production deployment and schema validation separately recorded in the public finding register
