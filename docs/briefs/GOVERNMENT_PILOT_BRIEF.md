...
- 6,721 automated test cases across 351 files, with all platform-applicable cases required to pass; Stryker.js mutation gate ≥90%; property-based and linearizability testing included
