...
- **Formal verification:** 26 TLA+ invariants (TLC model checker) and 35 Alloy facts with 32
  assertions across four models; 85 adversarial red-team cases; **6,872 automated test cases across 359 files, with every platform-applicable case required to pass**.
