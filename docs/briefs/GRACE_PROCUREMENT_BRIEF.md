...
- **Formal verification:** 26 TLA+ invariants (TLC model checker) and 35 Alloy facts with 32
  assertions across four models; 86 adversarial red-team cases; **7,000+ automated Vitest cases across 370+ files, with every platform-applicable case required to pass**.
