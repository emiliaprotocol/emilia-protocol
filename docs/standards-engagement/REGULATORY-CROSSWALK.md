...
21 suites / 340 vectors, a pinned external Rust verifier over its pinned 16-suite/164-vector clean-room bundle plus 359 hostile cases, and formal models with explicit scope. When harmonized standards and implementing acts are written for the
