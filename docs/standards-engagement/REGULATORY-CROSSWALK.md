...
16 suites / 164 vectors, a pinned external Rust verifier over the same suite plus 359 hostile cases, and formal models with explicit scope. When harmonized standards and implementing acts are written for the
