...
| MEASURE 2.1 | AI systems are tested before deployment | 5,400 automated test cases across 265 files, with all platform-applicable cases required to pass, plus 85 cataloged red-team cases, property-based and linearizability tests, and a mutation gate at or above 90%. |
