...
| MEASURE 2.1 | AI systems are tested before deployment | 6,606 automated test cases across 341 files, with all platform-applicable cases required to pass, plus 85 cataloged red-team cases, property-based and linearizability tests, and a mutation gate at or above 90%. |
