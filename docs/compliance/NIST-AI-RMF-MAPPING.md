...
| MEASURE 2.1 | AI systems are tested before deployment | 5,336 automated tests across 264 files, 85 cataloged red-team cases, property-based and linearizability tests, and a mutation gate at or above 90%. |
