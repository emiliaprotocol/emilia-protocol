...
| MAP 3.5 | Scientific integrity is maintained | EP formal verification: 20 TLA+ safety properties, 32 Alloy relational facts — machine-checked, CI-enforced. |
...
| MEASURE 2.1 | AI systems are tested before deployment | 670+ automated tests, 116 adversarial test cases, 31 property-based tests, mutation testing with 80%+ kill threshold. |
