...
predicate, with cryptographic operations treated as axioms at this
level. The process also emits ceremony telemetry that lets an evidence
...
directory, log checkpoints, and wall-clock time are not modeled.
Symbolic-cryptography verification of the composed protocol (a Tamarin
or ProVerif analysis with a Dolev-Yao adversary over the WebAuthn,
directory, and log composition) is future work, and we do not substitute
the results below for it.
...
\subsubsection{5.3 Enforced in code, not
