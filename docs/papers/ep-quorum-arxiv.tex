...
adversarial conformance suite of thirteen vectors that the JavaScript,
...
\item
  \textbf{An adversarial conformance suite} (Section 6) of thirteen vectors
...
thirteen vectors that each carry real Class-A WebAuthn (ES256) assertions:
