...
adversarial conformance suite of nine vectors that three independent
...
\item
  \textbf{An adversarial conformance suite} (Section 6) of nine vectors
...
nine vectors that each carry real Class-A WebAuthn (ES256) assertions:
