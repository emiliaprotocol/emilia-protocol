...
- immutable events
- a conformance surface and proof model

That means the company story should now be told as infrastructure, not as speculative trust theory.
...
- banking and payment-change fraud
- high-risk enterprise approvals
- agent execution controls

Software trust, package trust, MCP trust, and tool trust remain useful entry points, but they are now wedges into the broader category of action-level trust enforcement.
...
The protocol can remain open while the company builds monetizable layers around it:
- managed policy and control plane
- hosted verification and monitoring
- workflow integrations
- sector-specific policy packs
- audit and evidence tooling
- enterprise operations surfaces

## The strongest narrative

EP should now be described as:

> **A protocol-grade trust substrate for high-risk action enforcement.**

That is more accurate, more defensible, and more valuable than the earlier “portable trust for agents and software” framing.
