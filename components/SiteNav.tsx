...
import { color, cta } from '@/lib/tokens';
...
const NAV_LINKS: NavLink[] = [
  ['/workforce', 'Workforce'],
  ['/products', 'Products'],
  ...(process.env.NEXT_PUBLIC_WORKS_V0 === '1' ? [['/works', 'Work'] as NavLink] : []),
  ['/use-cases', 'Solutions'],
  ['/docs', 'Developers'],
  ['/proof', 'Proof'],
  ['/protocol', 'Protocol'],
  ...
  return (
    <header className="ep-site-header">
      <nav aria-label="Primary" style={{
        ...
        <div className="ep-nav-shell" style={{
          ...
          <div className="ep-nav-actions" style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
            ...
            <a href="/contact#workforce" className="ep-cta-secondary ep-nav-pilot" style={cta.secondary}>Discuss your workflow</a>
            ...
            <button
              ...
              aria-controls="ep-mobile-navigation"
            >
              {mobileOpen ? (
