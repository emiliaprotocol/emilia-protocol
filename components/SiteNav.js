     ...
     <div style={{
      ...
      <a href="/" className="ep-logo-link" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', flexShrink: 0 }}>
        <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
          ...
          <rect className="ep-top" x="9.5" y="5" width="16" height="2.5" rx="1.25" fill="#3B82F6" style={{ transition: 'transform 0.3s ease' }}/>
          <rect className="ep-mid" x="9.5" y="15.5" width="12" height="2.5" rx="1.25" fill="#22C55E" style={{ transition: 'transform 0.3s ease' }}/>
          <rect className="ep-bot" x="9.5" y="26.5" width="14" height="2.5" rx="1.25" fill="#3B82F6" style={{ transition: 'transform 0.3s ease' }}/>
          <defs><linearGradient id="sng" x1="8" y1="5" x2="8" y2="29"><stop offset="0%" stopColor="#3B82F6"/><stop offset="100%" stopColor="#22C55E"/></linearGradient></defs>
        </svg>
        <span style={{
        ...
        {NAV_LINKS.map(([href, label]) => (
          <a key={label} href={href}
            ...
            style={{
              ...
              color: label === activePage ? '#22C55E' : '#94A3B8',
              textDecoration: 'none', transition: 'color 0.2s',
              borderBottom: label === activePage ? '2px solid #22C55E' : '2px solid transparent',
              paddingBottom: 2,
            }}
            onMouseEnter={e => { if (label !== activePage) e.target.style.color = '#22C55E'; }}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
        ...
        onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(212,175,55,0.25)'; e.currentTarget.style.color = '#F8FAFC'; }}
