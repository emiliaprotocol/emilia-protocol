...
function fadeIn(frame: number, start: number, dur: number = 12): number {
...
function springIn(frame: number, fps: number, start: number, config: SpringConfig = { damping: 20, stiffness: 90, mass: 0.5 }): number {
...
function StepBar({ frame }: StepBarProps) {
...
function EyePanel({ frame, fps }: PanelProps) {
  ...
  type ActionRow = { k: string; v: string };
...
function HandshakePanel({ frame, fps }: PanelProps) {
...
/* ─── Phase Panel: Signoff ──────────────────────────────── */
function SignoffPanel({ frame, fps }: PanelProps) {
...
/* ─── Phase Panel: Commit ───────────────────────────────── */
function CommitPanel({ frame, fps }: PanelProps) {
...
function EventLog({ frame }: EventLogProps) {
...
/* ─── Grid Background ───────────────────────────────────── */
type GridBgProps = Record<string, never>;

function GridBg({}: GridBgProps) {
  return (
    <div style={{
