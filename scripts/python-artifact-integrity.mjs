...
// Generated from python-artifact-integrity.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
export function assertPythonArtifactBytesMatch(testedBytes, publishedBytes) {
    ...
    if (!tested.equals(published))
        throw new Error('published Python artifact bytes differ from the tested artifact');
