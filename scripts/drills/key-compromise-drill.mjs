...
// Generated from key-compromise-drill.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
import { buildRevocation, verifyRevocation, isRevoked, } from '../../lib/revocation/revocation.ts';
...
if (process.argv[1]?.endsWith('key-compromise-drill.mjs')) {
    ...
    if (result.accepted_after_revocation || !result.revocation_statement_valid)
        process.exit(1);
}
