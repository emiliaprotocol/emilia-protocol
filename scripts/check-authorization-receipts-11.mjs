...
invariant(vectors.cases?.length === 21, 'Authorization Bundle must publish 21 hostile cases');
invariant(new Set(vectors.cases.map((entry) => entry.id)).size === 21, 'Bundle vector IDs must be unique');
invariant(
