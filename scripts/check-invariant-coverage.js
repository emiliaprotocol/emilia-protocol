...
const CRITICAL_INVARIANTS = [
  ...
  {
    id: 'S14',
    name: 'Signoff requires verified handshake',
    codeTerms: ['signoff', 'challenge', 'verified'],
    testTerms: ['signoff', 'challenge', 'verified'],
    formalTerms: ['SignoffRequiresVerified', 'SignoffVerifiedHandshake'],
    docTerms: ['signoff', 'challenge', 'verified'],
  },
  {
    id: 'S15',
    name: 'Signoff consume once',
    codeTerms: ['signoff_consumption', 'unique', 'atomic'],
    testTerms: ['signoff_consumption', 'unique', 'atomic'],
    formalTerms: ['SignoffConsumeOnce', 'SignoffUniqueConsumption'],
    docTerms: ['signoff_consumption', 'unique', 'atomic'],
  },
  {
    id: 'S16',
    name: 'Signoff binding match',
    codeTerms: ['signoff', 'binding_hash', 'match'],
    testTerms: ['signoff', 'binding_hash', 'match'],
    formalTerms: ['SignoffBindingMatch', 'SignoffBindingHashMatch'],
    docTerms: ['signoff', 'binding_hash', 'match'],
  },
  {
    id: 'S17',
    name: 'Signoff terminal irreversible',
    codeTerms: ['signoff', 'terminal', 'denied', 'consumed'],
    testTerms: ['signoff', 'terminal', 'denied', 'consumed'],
    formalTerms: ['SignoffTerminalIrreversible', 'SignoffTerminalState'],
    docTerms: ['signoff', 'terminal', 'denied', 'consumed'],
  },
  {
    id: 'S18',
    name: 'Deny cannot be approved',
    codeTerms: ['denied', 'approved', 'signoff'],
    testTerms: ['denied', 'approved', 'signoff'],
    formalTerms: ['DenyCannotBeApproved', 'SignoffDenyTerminal'],
    docTerms: ['denied', 'approved', 'signoff'],
  },
  {
    id: 'S19',
    name: 'Signoff authority match',
    codeTerms: ['authority', 'signoff', 'actor'],
    testTerms: ['authority', 'signoff', 'actor'],
    formalTerms: ['SignoffAuthorityMatch', 'SignoffActorAuthority'],
    docTerms: ['authority', 'signoff', 'actor'],
  },
];
