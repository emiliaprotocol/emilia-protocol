...
async function main() {
  ...
  if (!APPROVER.test(approver || '')) throw new Error('--approver must be 3-128 characters of [A-Za-z0-9:_.@-]');
  if (!SCENARIOS.has(scenario)) throw new Error('--scenario must be grid, treasury, or healthcare');
