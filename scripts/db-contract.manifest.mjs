...
// Generated from db-contract.manifest.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
const OPEN_EXPOSURE_QUALIFIED_TABLES = [
...
const OPEN_EXPOSURE_QUALIFIED_RPCS = [
...
const OPEN_EXPOSURE_SECURITY_ASSERTIONS = [
...
const STRIX_RLS_CLOSURE_TABLES = [
