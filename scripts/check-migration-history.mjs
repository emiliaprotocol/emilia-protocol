...
export function validateMigrationHistory(root = ROOT) {
    ...
    invariant(history.requires_include_all === (history.retroactive_pending_versions.length > 0), 'requires_include_all must be true exactly while retroactive migrations are pending');
