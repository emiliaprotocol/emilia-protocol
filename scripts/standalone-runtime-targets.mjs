...
export const STANDALONE_RUNTIME_SOURCES = [
  ...
  'lib/auth/observe-scope.ts',
  'lib/auth/protocol-request-authorization.ts',
  ...
  'lib/trust-desk/resource-budget.ts',
