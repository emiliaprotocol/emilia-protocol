...
// Generated from check-frozen-clean-room.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
//
...
function assert(condition, message) {
    if (!condition)
        throw new Error(`frozen clean-room baseline: ${message}`);
}
const manifestInput = readStrictJson(MANIFEST_PATH, 'manifest');
const bundleInput = readStrictJson(BUNDLE_PATH, 'bundle');
...
assert(manifest.manifest_sha256 === sha256(Buffer.from(canonicalize(withoutHash), 'utf8')), 'manifest self-hash mismatch');
