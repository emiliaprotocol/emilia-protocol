// Generated from cli.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
 ...
 */
export function runOfflineVerifier(args, { stdout = process.stdout, stderr = process.stderr } = {}) {
 ...
 * }} [options]
 */
export async function runCli(args, { env = process.env, stdout = process.stdout, stderr = process.stderr, client: suppliedClient, } = {}) {
    ...
    try {
        switch (command) {
            case 'register': {
                ...
                if (!requireApiKey(apiKey, stderr))
                    return 1;
