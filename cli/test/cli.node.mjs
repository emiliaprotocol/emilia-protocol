// Generated from cli.node.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
...
test('API client turns non-JSON failures into bounded errors', async () => {
    const client = new EPClient('https://example.test', '', async () => new Response('<html>upstream unavailable</html>', { status: 502 }));
