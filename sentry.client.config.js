...
const configuredEnvironment = process.env.NEXT_PUBLIC_SENTRY_ENVIRONMENT ?? 'development';
...
function sanitizeTags(tags) {
  ...
  if (tags.service === 'emilia-protocol-web') safe.service = tags.service;
  if (tags.runtime === 'browser') safe.runtime = tags.runtime;
  return Object.keys(safe).length ? safe : undefined;
}
