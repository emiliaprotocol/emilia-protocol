...
# Public Due-Diligence Evidence (reviewed 2026-08-12)

> Historical snapshot. For the current public evidence map, see
> [`DUE_DILIGENCE.md`](DUE_DILIGENCE.md).
...
| --- | --- | --- |
| Tests and build | **8,865 tests across 533 files** in [`lib/proof-stats.json`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/lib/proof-stats.json); the production Next.js build is rerun during the release gate. | Passing tests are scoped regression evidence, not whole-system proof. |
...
[`packages/verify/src/aeb-adapter-contract.ts`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/packages/verify/src/aeb-adapter-contract.ts),
...
[`lib/proof-stats.json`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/lib/proof-stats.json). Review the underlying files and
...
Formal rerun instructions are in [`formal/RUN_TLC.md`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/formal/RUN_TLC.md),
[`formal/RUN_ALLOY.md`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/formal/RUN_ALLOY.md), and
[`formal/tamarin/README.md`](https://github.com/emiliaprotocol/emilia-protocol/blob/f6f6a1c771a12f794144e1d04faffe42ce7d4184/formal/tamarin/README.md). Some formal checks
