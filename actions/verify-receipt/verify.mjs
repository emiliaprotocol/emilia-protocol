// Generated from verify.mts by scripts/build-standalone-runtimes.mjs. Do not edit.
/* eslint-disable */
/**
...
if (!receiptPath)
    fail(2, 'receipt input is required (path to an EP-RECEIPT-v1 JSON file).');
...
if (candidates.length === 0)
    fail(2, 'No public keys available to verify against.');
let result = null;
