...
const MATERIAL_RENDERINGS = Object.freeze({
  ...
  rollout_policy_mode: ['Rollout policy mode', 'mutual'],
  rollout_policy_status: ['Rollout policy status', 'active'],
...
const CHANGED_MATERIAL = Object.freeze({
  ...
  rollout_policy_mode: 'one_sided',
  rollout_policy_status: 'deprecated',
