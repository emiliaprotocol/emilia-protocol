...
describe('EP Conformance Suite -- Protocol Invariants', () => {
  ...
  describe('Invariant 1: Write-path completeness', () => {
    ...
    it('COMMAND_TYPES is non-empty and has exactly 30 command types', () => {
    ...
    it('aggregate types are one of the known aggregates', () => {
      const KNOWN_AGGREGATES = new Set(['receipt', 'commit', 'dispute', 'report', 'handshake', 'signoff', 'continuity']);
      for (const type of types) {
