...
describe('npm internal dependency registry guard', () => {
    ...
    const downstream = [
      {
        ...
        expectedPins: [
          ...
          {
            spec: '@emilia-protocol/verify@4.1.0',
            sha256: '41cec635cb13360d13c564a0f92c0cc8897f7db44f3285ad61b7b7224a840b80',
          },
        ],
      },
      {
  ...
  it('refuses malformed, duplicate, or undeclared dependency byte pins', () => {
    ...
    expect(() => collectRegistryDependencyTarballPins(
      GATE_METADATA,
      'packages/gate',
      withPins([{ spec: '@emilia-protocol/verify@4.1.0', sha256: 'not-a-sha256' }]),
